...
class AuthorizationQueries extends AbstractAuthorizationQueries {
	...
	val Map<Class<? extends Asset>, Map<OperationKind, IQuerySpecification>> effectivelyDeniedQuery = #{
		ObjectAsset -> temp1,
		AttributeAsset -> temp2,
		ReferenceAsset -> temp3
	}
