...
/**
 * Pattern-specific match representation of the wt.merge.iq.containmentPattern pattern,
...
public abstract class ContainmentPatternMatch extends BasePatternMatch {
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("parent".equals(parameterName) ) {
    	this.fParent = (org.eclipse.emf.ecore.EObject) newValue;
    	return true;
    }
    if ("child".equals(parameterName) ) {
    	this.fChild = (org.eclipse.emf.ecore.EObject) newValue;
    	return true;
    }
    return false;
  }
