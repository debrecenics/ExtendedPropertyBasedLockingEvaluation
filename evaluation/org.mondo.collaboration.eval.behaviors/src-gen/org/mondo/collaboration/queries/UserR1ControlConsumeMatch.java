...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.queries.userR1ControlConsume pattern,
 * to be used in conjunction with {@link UserR1ControlConsumeMatcher}.
 * 
 ...
 * 
 * @see UserR1ControlConsumeMatcher
 * @see UserR1ControlConsumeProcessor
 * 
 */
@SuppressWarnings("all")
public abstract class UserR1ControlConsumeMatch extends BasePatternMatch {
  ...
  private UserR1ControlConsumeMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
  ...
  public String patternName() {
    return "org.mondo.collaboration.queries.userR1ControlConsume";
  }
  
  @Override
  public List<String> parameterNames() {
    return UserR1ControlConsumeMatch.parameterNames;
  }
  ...
  @Override
  public UserR1ControlConsumeMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof UserR1ControlConsumeMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    UserR1ControlConsumeMatch other = (UserR1ControlConsumeMatch) obj;
  ...
  @Override
  public UserR1ControlConsumeQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static UserR1ControlConsumeMatch newEmptyMatch() {
   ...
   * 
   */
  public static UserR1ControlConsumeMatch newMutableMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
   ...
   * 
   */
  public static UserR1ControlConsumeMatch newMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
    return new Immutable(pVendor, pObject, pSignal, pComposite);
  }
  
  private static final class Mutable extends UserR1ControlConsumeMatch {
  ...
  private static final class Immutable extends UserR1ControlConsumeMatch {
