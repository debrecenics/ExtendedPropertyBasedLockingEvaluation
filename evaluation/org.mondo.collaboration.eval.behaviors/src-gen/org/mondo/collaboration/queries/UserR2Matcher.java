...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.queries.userR2 pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link UserR2Match}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see UserR2Match
 * @see UserR2Processor
 * @see UserR2QuerySpecification
 * 
 */
@SuppressWarnings("all")
public class UserR2Matcher extends BaseMatcher<UserR2Match> {
  /**
   ...
   * 
   */
  public static UserR2Matcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    UserR2Matcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new UserR2Matcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(UserR2Matcher.class);
   ...
   */
  @Deprecated
  public UserR2Matcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public UserR2Matcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a UserR2Match object.
   * 
   */
  public Collection<UserR2Match> getAllMatches(final String pVendor, final Object pObject, final Composite pComposite) {
   ...
   * @param pObject the fixed value of pattern parameter object, or null if not bound.
   * @param pComposite the fixed value of pattern parameter composite, or null if not bound.
   * @return a match represented as a UserR2Match object, or null if no match is found.
   * 
   */
  public UserR2Match getOneArbitraryMatch(final String pVendor, final Object pObject, final Composite pComposite) {
   ...
   * 
   */
  public void forEachMatch(final String pVendor, final Object pObject, final Composite pComposite, final IMatchProcessor<? super UserR2Match> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pVendor, final Object pObject, final Composite pComposite, final IMatchProcessor<? super UserR2Match> processor) {
   ...
   * 
   */
  public UserR2Match newMatch(final String pVendor, final Object pObject, final Composite pComposite) {
    return UserR2Match.newMatch(pVendor, pObject, pComposite);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfvendor(final UserR2Match partialMatch) {
   ...
   * 
   */
  public Set<Object> getAllValuesOfobject(final UserR2Match partialMatch) {
   ...
   * 
   */
  public Set<Composite> getAllValuesOfcomposite(final UserR2Match partialMatch) {
  ...
  @Override
  protected UserR2Match tupleToMatch(final Tuple t) {
    try {
    	return UserR2Match.newMatch((java.lang.String) t.get(POSITION_VENDOR), (java.lang.Object) t.get(POSITION_OBJECT), (wt.Composite) t.get(POSITION_COMPOSITE));
  ...
  @Override
  protected UserR2Match arrayToMatch(final Object[] match) {
    try {
    	return UserR2Match.newMatch((java.lang.String) match[POSITION_VENDOR], (java.lang.Object) match[POSITION_OBJECT], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected UserR2Match arrayToMatchMutable(final Object[] match) {
    try {
    	return UserR2Match.newMutableMatch((java.lang.String) match[POSITION_VENDOR], (java.lang.Object) match[POSITION_OBJECT], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<UserR2Matcher> querySpecification() throws IncQueryException {
