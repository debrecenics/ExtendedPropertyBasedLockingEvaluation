...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.queries.userT1 pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link UserT1Match}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see UserT1Match
 * @see UserT1Processor
 * @see UserT1QuerySpecification
 * 
 */
@SuppressWarnings("all")
public class UserT1Matcher extends BaseMatcher<UserT1Match> {
  /**
   ...
   * 
   */
  public static UserT1Matcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    UserT1Matcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new UserT1Matcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(UserT1Matcher.class);
   ...
   */
  @Deprecated
  public UserT1Matcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public UserT1Matcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a UserT1Match object.
   * 
   */
  public Collection<UserT1Match> getAllMatches(final Control pCtrl, final Signal pSgn, final String pC, final String pT) {
   ...
   * @param pC the fixed value of pattern parameter c, or null if not bound.
   * @param pT the fixed value of pattern parameter t, or null if not bound.
   * @return a match represented as a UserT1Match object, or null if no match is found.
   * 
   */
  public UserT1Match getOneArbitraryMatch(final Control pCtrl, final Signal pSgn, final String pC, final String pT) {
   ...
   * 
   */
  public void forEachMatch(final Control pCtrl, final Signal pSgn, final String pC, final String pT, final IMatchProcessor<? super UserT1Match> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Control pCtrl, final Signal pSgn, final String pC, final String pT, final IMatchProcessor<? super UserT1Match> processor) {
   ...
   * 
   */
  public UserT1Match newMatch(final Control pCtrl, final Signal pSgn, final String pC, final String pT) {
    return UserT1Match.newMatch(pCtrl, pSgn, pC, pT);
  }
   ...
   * 
   */
  public Set<Control> getAllValuesOfctrl(final UserT1Match partialMatch) {
   ...
   * 
   */
  public Set<Signal> getAllValuesOfsgn(final UserT1Match partialMatch) {
   ...
   * 
   */
  public Set<String> getAllValuesOfc(final UserT1Match partialMatch) {
   ...
   * 
   */
  public Set<String> getAllValuesOft(final UserT1Match partialMatch) {
  ...
  @Override
  protected UserT1Match tupleToMatch(final Tuple t) {
    try {
    	return UserT1Match.newMatch((wt.Control) t.get(POSITION_CTRL), (wt.Signal) t.get(POSITION_SGN), (java.lang.String) t.get(POSITION_C), (java.lang.String) t.get(POSITION_T));
  ...
  @Override
  protected UserT1Match arrayToMatch(final Object[] match) {
    try {
    	return UserT1Match.newMatch((wt.Control) match[POSITION_CTRL], (wt.Signal) match[POSITION_SGN], (java.lang.String) match[POSITION_C], (java.lang.String) match[POSITION_T]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected UserT1Match arrayToMatchMutable(final Object[] match) {
    try {
    	return UserT1Match.newMutableMatch((wt.Control) match[POSITION_CTRL], (wt.Signal) match[POSITION_SGN], (java.lang.String) match[POSITION_C], (java.lang.String) match[POSITION_T]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<UserT1Matcher> querySpecification() throws IncQueryException {
