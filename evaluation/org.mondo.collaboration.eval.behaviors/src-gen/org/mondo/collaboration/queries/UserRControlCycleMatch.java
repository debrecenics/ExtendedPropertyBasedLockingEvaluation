...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.queries.userRControlCycle pattern,
 * to be used in conjunction with {@link UserRControlCycleMatcher}.
 * 
...
public abstract class UserRControlCycleMatch extends BasePatternMatch {
  ...
  private UserRControlCycleMatch(final String pVendor, final Control pObject, final String pCycle, final Composite pComposite) {
  ...
  public List<String> parameterNames() {
    return UserRControlCycleMatch.parameterNames;
  }
  ...
  @Override
  public UserRControlCycleMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof UserRControlCycleMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    UserRControlCycleMatch other = (UserRControlCycleMatch) obj;
  ...
  @Override
  public UserRControlCycleQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static UserRControlCycleMatch newEmptyMatch() {
   ...
   * 
   */
  public static UserRControlCycleMatch newMutableMatch(final String pVendor, final Control pObject, final String pCycle, final Composite pComposite) {
   ...
   * 
   */
  public static UserRControlCycleMatch newMatch(final String pVendor, final Control pObject, final String pCycle, final Composite pComposite) {
    return new Immutable(pVendor, pObject, pCycle, pComposite);
  }
  
  private static final class Mutable extends UserRControlCycleMatch {
  ...
  private static final class Immutable extends UserRControlCycleMatch {
