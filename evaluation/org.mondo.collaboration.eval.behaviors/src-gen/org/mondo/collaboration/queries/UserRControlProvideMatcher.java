...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.queries.userRControlProvide pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link UserRControlProvideMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * </pre></code>
 * 
 * @see UserRControlProvideMatch
 * @see UserRControlProvideProcessor
 * @see UserRControlProvideQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class UserRControlProvideMatcher extends BaseMatcher<UserRControlProvideMatch> {
  /**
   ...
   * 
   */
  public static UserRControlProvideMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    UserRControlProvideMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new UserRControlProvideMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(UserRControlProvideMatcher.class);
   ...
   */
  @Deprecated
  public UserRControlProvideMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public UserRControlProvideMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a UserRControlProvideMatch object.
   * 
   */
  public Collection<UserRControlProvideMatch> getAllMatches(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
   ...
   * @param pSignal the fixed value of pattern parameter signal, or null if not bound.
   * @param pComposite the fixed value of pattern parameter composite, or null if not bound.
   * @return a match represented as a UserRControlProvideMatch object, or null if no match is found.
   * 
   */
  public UserRControlProvideMatch getOneArbitraryMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
   ...
   * 
   */
  public void forEachMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite, final IMatchProcessor<? super UserRControlProvideMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite, final IMatchProcessor<? super UserRControlProvideMatch> processor) {
   ...
   * 
   */
  public UserRControlProvideMatch newMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
    return UserRControlProvideMatch.newMatch(pVendor, pObject, pSignal, pComposite);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfvendor(final UserRControlProvideMatch partialMatch) {
   ...
   * 
   */
  public Set<Control> getAllValuesOfobject(final UserRControlProvideMatch partialMatch) {
   ...
   * 
   */
  public Set<Signal> getAllValuesOfsignal(final UserRControlProvideMatch partialMatch) {
   ...
   * 
   */
  public Set<Composite> getAllValuesOfcomposite(final UserRControlProvideMatch partialMatch) {
  ...
  @Override
  protected UserRControlProvideMatch tupleToMatch(final Tuple t) {
    try {
    	return UserRControlProvideMatch.newMatch((java.lang.String) t.get(POSITION_VENDOR), (wt.Control) t.get(POSITION_OBJECT), (wt.Signal) t.get(POSITION_SIGNAL), (wt.Composite) t.get(POSITION_COMPOSITE));
  ...
  @Override
  protected UserRControlProvideMatch arrayToMatch(final Object[] match) {
    try {
    	return UserRControlProvideMatch.newMatch((java.lang.String) match[POSITION_VENDOR], (wt.Control) match[POSITION_OBJECT], (wt.Signal) match[POSITION_SIGNAL], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected UserRControlProvideMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return UserRControlProvideMatch.newMutableMatch((java.lang.String) match[POSITION_VENDOR], (wt.Control) match[POSITION_OBJECT], (wt.Signal) match[POSITION_SIGNAL], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<UserRControlProvideMatcher> querySpecification() throws IncQueryException {
