...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.queries.userR0ControlType pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link UserR0ControlTypeMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * </pre></code>
 * 
 * @see UserR0ControlTypeMatch
 * @see UserR0ControlTypeProcessor
 * @see UserR0ControlTypeQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class UserR0ControlTypeMatcher extends BaseMatcher<UserR0ControlTypeMatch> {
  /**
   ...
   * 
   */
  public static UserR0ControlTypeMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    UserR0ControlTypeMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new UserR0ControlTypeMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(UserR0ControlTypeMatcher.class);
   ...
   */
  @Deprecated
  public UserR0ControlTypeMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public UserR0ControlTypeMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a UserR0ControlTypeMatch object.
   * 
   */
  public Collection<UserR0ControlTypeMatch> getAllMatches(final String pVendor, final Control pObject, final String pType, final Composite pComposite) {
   ...
   * @param pType the fixed value of pattern parameter type, or null if not bound.
   * @param pComposite the fixed value of pattern parameter composite, or null if not bound.
   * @return a match represented as a UserR0ControlTypeMatch object, or null if no match is found.
   * 
   */
  public UserR0ControlTypeMatch getOneArbitraryMatch(final String pVendor, final Control pObject, final String pType, final Composite pComposite) {
   ...
   * 
   */
  public void forEachMatch(final String pVendor, final Control pObject, final String pType, final Composite pComposite, final IMatchProcessor<? super UserR0ControlTypeMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pVendor, final Control pObject, final String pType, final Composite pComposite, final IMatchProcessor<? super UserR0ControlTypeMatch> processor) {
   ...
   * 
   */
  public UserR0ControlTypeMatch newMatch(final String pVendor, final Control pObject, final String pType, final Composite pComposite) {
    return UserR0ControlTypeMatch.newMatch(pVendor, pObject, pType, pComposite);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfvendor(final UserR0ControlTypeMatch partialMatch) {
   ...
   * 
   */
  public Set<Control> getAllValuesOfobject(final UserR0ControlTypeMatch partialMatch) {
   ...
   * 
   */
  public Set<String> getAllValuesOftype(final UserR0ControlTypeMatch partialMatch) {
   ...
   * 
   */
  public Set<Composite> getAllValuesOfcomposite(final UserR0ControlTypeMatch partialMatch) {
  ...
  @Override
  protected UserR0ControlTypeMatch tupleToMatch(final Tuple t) {
    try {
    	return UserR0ControlTypeMatch.newMatch((java.lang.String) t.get(POSITION_VENDOR), (wt.Control) t.get(POSITION_OBJECT), (java.lang.String) t.get(POSITION_TYPE), (wt.Composite) t.get(POSITION_COMPOSITE));
  ...
  @Override
  protected UserR0ControlTypeMatch arrayToMatch(final Object[] match) {
    try {
    	return UserR0ControlTypeMatch.newMatch((java.lang.String) match[POSITION_VENDOR], (wt.Control) match[POSITION_OBJECT], (java.lang.String) match[POSITION_TYPE], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected UserR0ControlTypeMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return UserR0ControlTypeMatch.newMutableMatch((java.lang.String) match[POSITION_VENDOR], (wt.Control) match[POSITION_OBJECT], (java.lang.String) match[POSITION_TYPE], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<UserR0ControlTypeMatcher> querySpecification() throws IncQueryException {
