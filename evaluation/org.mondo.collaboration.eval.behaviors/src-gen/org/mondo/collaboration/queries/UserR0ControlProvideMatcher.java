...
import org.mondo.collaboration.queries.UserR0ControlProvideMatch;
...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.queries.userR0ControlProvide pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link UserR0ControlProvideMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * </pre></code>
 * 
 * @see UserR0ControlProvideMatch
 * @see UserR0ControlProvideProcessor
 * @see UserR0ControlProvideQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class UserR0ControlProvideMatcher extends BaseMatcher<UserR0ControlProvideMatch> {
  /**
   ...
   * 
   */
  public static UserR0ControlProvideMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    UserR0ControlProvideMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new UserR0ControlProvideMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(UserR0ControlProvideMatcher.class);
   ...
   */
  @Deprecated
  public UserR0ControlProvideMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public UserR0ControlProvideMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a UserR0ControlProvideMatch object.
   * 
   */
  public Collection<UserR0ControlProvideMatch> getAllMatches(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
   ...
   * @param pSignal the fixed value of pattern parameter signal, or null if not bound.
   * @param pComposite the fixed value of pattern parameter composite, or null if not bound.
   * @return a match represented as a UserR0ControlProvideMatch object, or null if no match is found.
   * 
   */
  public UserR0ControlProvideMatch getOneArbitraryMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
   ...
   * 
   */
  public void forEachMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite, final IMatchProcessor<? super UserR0ControlProvideMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite, final IMatchProcessor<? super UserR0ControlProvideMatch> processor) {
   ...
   * 
   */
  public UserR0ControlProvideMatch newMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
    return UserR0ControlProvideMatch.newMatch(pVendor, pObject, pSignal, pComposite);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfvendor(final UserR0ControlProvideMatch partialMatch) {
   ...
   * 
   */
  public Set<Control> getAllValuesOfobject(final UserR0ControlProvideMatch partialMatch) {
   ...
   * 
   */
  public Set<Signal> getAllValuesOfsignal(final UserR0ControlProvideMatch partialMatch) {
   ...
   * 
   */
  public Set<Composite> getAllValuesOfcomposite(final UserR0ControlProvideMatch partialMatch) {
  ...
  @Override
  protected UserR0ControlProvideMatch tupleToMatch(final Tuple t) {
    try {
    	return UserR0ControlProvideMatch.newMatch((java.lang.String) t.get(POSITION_VENDOR), (wt.Control) t.get(POSITION_OBJECT), (wt.Signal) t.get(POSITION_SIGNAL), (wt.Composite) t.get(POSITION_COMPOSITE));
  ...
  @Override
  protected UserR0ControlProvideMatch arrayToMatch(final Object[] match) {
    try {
    	return UserR0ControlProvideMatch.newMatch((java.lang.String) match[POSITION_VENDOR], (wt.Control) match[POSITION_OBJECT], (wt.Signal) match[POSITION_SIGNAL], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected UserR0ControlProvideMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return UserR0ControlProvideMatch.newMutableMatch((java.lang.String) match[POSITION_VENDOR], (wt.Control) match[POSITION_OBJECT], (wt.Signal) match[POSITION_SIGNAL], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<UserR0ControlProvideMatcher> querySpecification() throws IncQueryException {
