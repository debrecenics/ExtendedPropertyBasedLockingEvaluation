...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.queries.userR1ControlProvide pattern,
 * to be used in conjunction with {@link UserR1ControlProvideMatcher}.
 * 
...
public abstract class UserR1ControlProvideMatch extends BasePatternMatch {
  ...
  private UserR1ControlProvideMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
  ...
  public List<String> parameterNames() {
    return UserR1ControlProvideMatch.parameterNames;
  }
  ...
  @Override
  public UserR1ControlProvideMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof UserR1ControlProvideMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    UserR1ControlProvideMatch other = (UserR1ControlProvideMatch) obj;
  ...
  @Override
  public UserR1ControlProvideQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static UserR1ControlProvideMatch newEmptyMatch() {
   ...
   * 
   */
  public static UserR1ControlProvideMatch newMutableMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
   ...
   * 
   */
  public static UserR1ControlProvideMatch newMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
    return new Immutable(pVendor, pObject, pSignal, pComposite);
  }
  
  private static final class Mutable extends UserR1ControlProvideMatch {
  ...
  private static final class Immutable extends UserR1ControlProvideMatch {
