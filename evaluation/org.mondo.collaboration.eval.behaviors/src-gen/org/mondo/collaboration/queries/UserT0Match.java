...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.queries.userT0 pattern,
 * to be used in conjunction with {@link UserT0Matcher}.
 * 
...
public abstract class UserT0Match extends BasePatternMatch {
  ...
  private UserT0Match(final Control pCtrl, final Signal pSgn, final String pC, final String pT) {
    this.fCtrl = pCtrl;
    this.fSgn = pSgn;
    this.fC = pC;
    this.fT = pT;
  ...
  public List<String> parameterNames() {
    return UserT0Match.parameterNames;
  }
  ...
  @Override
  public UserT0Match toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof UserT0Match)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    UserT0Match other = (UserT0Match) obj;
  ...
  @Override
  public UserT0QuerySpecification specification() {
    try {
   ...
   * 
   */
  public static UserT0Match newEmptyMatch() {
   ...
   * 
   */
  public static UserT0Match newMutableMatch(final Control pCtrl, final Signal pSgn, final String pC, final String pT) {
   ...
   * 
   */
  public static UserT0Match newMatch(final Control pCtrl, final Signal pSgn, final String pC, final String pT) {
    return new Immutable(pCtrl, pSgn, pC, pT);
  }
  
  private static final class Mutable extends UserT0Match {
  ...
  private static final class Immutable extends UserT0Match {
