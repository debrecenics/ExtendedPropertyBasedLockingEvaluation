...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.queries.userR1 pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link UserR1Match}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see UserR1Match
 * @see UserR1Processor
 * @see UserR1QuerySpecification
 * 
 */
@SuppressWarnings("all")
public class UserR1Matcher extends BaseMatcher<UserR1Match> {
  /**
   ...
   * 
   */
  public static UserR1Matcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    UserR1Matcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new UserR1Matcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(UserR1Matcher.class);
   ...
   */
  @Deprecated
  public UserR1Matcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public UserR1Matcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a UserR1Match object.
   * 
   */
  public Collection<UserR1Match> getAllMatches(final String pVendor, final Object pObject, final Composite pComposite) {
   ...
   * @param pObject the fixed value of pattern parameter object, or null if not bound.
   * @param pComposite the fixed value of pattern parameter composite, or null if not bound.
   * @return a match represented as a UserR1Match object, or null if no match is found.
   * 
   */
  public UserR1Match getOneArbitraryMatch(final String pVendor, final Object pObject, final Composite pComposite) {
   ...
   * 
   */
  public void forEachMatch(final String pVendor, final Object pObject, final Composite pComposite, final IMatchProcessor<? super UserR1Match> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pVendor, final Object pObject, final Composite pComposite, final IMatchProcessor<? super UserR1Match> processor) {
   ...
   * 
   */
  public UserR1Match newMatch(final String pVendor, final Object pObject, final Composite pComposite) {
    return UserR1Match.newMatch(pVendor, pObject, pComposite);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfvendor(final UserR1Match partialMatch) {
   ...
   * 
   */
  public Set<Object> getAllValuesOfobject(final UserR1Match partialMatch) {
   ...
   * 
   */
  public Set<Composite> getAllValuesOfcomposite(final UserR1Match partialMatch) {
  ...
  @Override
  protected UserR1Match tupleToMatch(final Tuple t) {
    try {
    	return UserR1Match.newMatch((java.lang.String) t.get(POSITION_VENDOR), (java.lang.Object) t.get(POSITION_OBJECT), (wt.Composite) t.get(POSITION_COMPOSITE));
  ...
  @Override
  protected UserR1Match arrayToMatch(final Object[] match) {
    try {
    	return UserR1Match.newMatch((java.lang.String) match[POSITION_VENDOR], (java.lang.Object) match[POSITION_OBJECT], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected UserR1Match arrayToMatchMutable(final Object[] match) {
    try {
    	return UserR1Match.newMutableMatch((java.lang.String) match[POSITION_VENDOR], (java.lang.Object) match[POSITION_OBJECT], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<UserR1Matcher> querySpecification() throws IncQueryException {
