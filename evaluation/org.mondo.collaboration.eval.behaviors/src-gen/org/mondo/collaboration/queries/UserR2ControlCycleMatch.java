...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.queries.userR2ControlCycle pattern,
 * to be used in conjunction with {@link UserR2ControlCycleMatcher}.
 * 
...
public abstract class UserR2ControlCycleMatch extends BasePatternMatch {
  ...
  private UserR2ControlCycleMatch(final String pVendor, final Control pObject, final String pCycle, final Composite pComposite) {
  ...
  public List<String> parameterNames() {
    return UserR2ControlCycleMatch.parameterNames;
  }
  ...
  @Override
  public UserR2ControlCycleMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof UserR2ControlCycleMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    UserR2ControlCycleMatch other = (UserR2ControlCycleMatch) obj;
  ...
  @Override
  public UserR2ControlCycleQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static UserR2ControlCycleMatch newEmptyMatch() {
   ...
   * 
   */
  public static UserR2ControlCycleMatch newMutableMatch(final String pVendor, final Control pObject, final String pCycle, final Composite pComposite) {
   ...
   * 
   */
  public static UserR2ControlCycleMatch newMatch(final String pVendor, final Control pObject, final String pCycle, final Composite pComposite) {
    return new Immutable(pVendor, pObject, pCycle, pComposite);
  }
  
  private static final class Mutable extends UserR2ControlCycleMatch {
  ...
  private static final class Immutable extends UserR2ControlCycleMatch {
