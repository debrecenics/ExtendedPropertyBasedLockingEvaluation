...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.queries.userRSignalFrequency pattern,
 * to be used in conjunction with {@link UserRSignalFrequencyMatcher}.
 * 
...
public abstract class UserRSignalFrequencyMatch extends BasePatternMatch {
  ...
  private UserRSignalFrequencyMatch(final String pVendor, final Signal pObject, final Integer pFrequency, final Composite pComposite) {
  ...
  public List<String> parameterNames() {
    return UserRSignalFrequencyMatch.parameterNames;
  }
  ...
  @Override
  public UserRSignalFrequencyMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof UserRSignalFrequencyMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    UserRSignalFrequencyMatch other = (UserRSignalFrequencyMatch) obj;
  ...
  @Override
  public UserRSignalFrequencyQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static UserRSignalFrequencyMatch newEmptyMatch() {
   ...
   * 
   */
  public static UserRSignalFrequencyMatch newMutableMatch(final String pVendor, final Signal pObject, final Integer pFrequency, final Composite pComposite) {
   ...
   * 
   */
  public static UserRSignalFrequencyMatch newMatch(final String pVendor, final Signal pObject, final Integer pFrequency, final Composite pComposite) {
    return new Immutable(pVendor, pObject, pFrequency, pComposite);
  }
  
  private static final class Mutable extends UserRSignalFrequencyMatch {
  ...
  private static final class Immutable extends UserRSignalFrequencyMatch {
