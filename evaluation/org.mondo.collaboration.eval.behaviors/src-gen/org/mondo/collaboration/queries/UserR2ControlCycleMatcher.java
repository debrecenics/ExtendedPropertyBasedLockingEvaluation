...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.queries.userR2ControlCycle pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link UserR2ControlCycleMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see UserR2ControlCycleProcessor
 * @see UserR2ControlCycleQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class UserR2ControlCycleMatcher extends BaseMatcher<UserR2ControlCycleMatch> {
  /**
   ...
   * 
   */
  public static UserR2ControlCycleMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    UserR2ControlCycleMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new UserR2ControlCycleMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(UserR2ControlCycleMatcher.class);
   ...
   */
  @Deprecated
  public UserR2ControlCycleMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public UserR2ControlCycleMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a UserR2ControlCycleMatch object.
   * 
   */
  public Collection<UserR2ControlCycleMatch> getAllMatches(final String pVendor, final Control pObject, final String pCycle, final Composite pComposite) {
   ...
   * @param pCycle the fixed value of pattern parameter cycle, or null if not bound.
   * @param pComposite the fixed value of pattern parameter composite, or null if not bound.
   * @return a match represented as a UserR2ControlCycleMatch object, or null if no match is found.
   * 
   */
  public UserR2ControlCycleMatch getOneArbitraryMatch(final String pVendor, final Control pObject, final String pCycle, final Composite pComposite) {
   ...
   * 
   */
  public void forEachMatch(final String pVendor, final Control pObject, final String pCycle, final Composite pComposite, final IMatchProcessor<? super UserR2ControlCycleMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pVendor, final Control pObject, final String pCycle, final Composite pComposite, final IMatchProcessor<? super UserR2ControlCycleMatch> processor) {
   ...
   * 
   */
  public UserR2ControlCycleMatch newMatch(final String pVendor, final Control pObject, final String pCycle, final Composite pComposite) {
    return UserR2ControlCycleMatch.newMatch(pVendor, pObject, pCycle, pComposite);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfvendor(final UserR2ControlCycleMatch partialMatch) {
   ...
   * 
   */
  public Set<Control> getAllValuesOfobject(final UserR2ControlCycleMatch partialMatch) {
   ...
   * 
   */
  public Set<String> getAllValuesOfcycle(final UserR2ControlCycleMatch partialMatch) {
   ...
   * 
   */
  public Set<Composite> getAllValuesOfcomposite(final UserR2ControlCycleMatch partialMatch) {
  ...
  @Override
  protected UserR2ControlCycleMatch tupleToMatch(final Tuple t) {
    try {
    	return UserR2ControlCycleMatch.newMatch((java.lang.String) t.get(POSITION_VENDOR), (wt.Control) t.get(POSITION_OBJECT), (java.lang.String) t.get(POSITION_CYCLE), (wt.Composite) t.get(POSITION_COMPOSITE));
  ...
  @Override
  protected UserR2ControlCycleMatch arrayToMatch(final Object[] match) {
    try {
    	return UserR2ControlCycleMatch.newMatch((java.lang.String) match[POSITION_VENDOR], (wt.Control) match[POSITION_OBJECT], (java.lang.String) match[POSITION_CYCLE], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected UserR2ControlCycleMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return UserR2ControlCycleMatch.newMutableMatch((java.lang.String) match[POSITION_VENDOR], (wt.Control) match[POSITION_OBJECT], (java.lang.String) match[POSITION_CYCLE], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<UserR2ControlCycleMatcher> querySpecification() throws IncQueryException {
