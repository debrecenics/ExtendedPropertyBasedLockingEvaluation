...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.queries.userR1SignalFrequency pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link UserR1SignalFrequencyMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see UserR1SignalFrequencyProcessor
 * @see UserR1SignalFrequencyQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class UserR1SignalFrequencyMatcher extends BaseMatcher<UserR1SignalFrequencyMatch> {
  /**
   ...
   * 
   */
  public static UserR1SignalFrequencyMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    UserR1SignalFrequencyMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new UserR1SignalFrequencyMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(UserR1SignalFrequencyMatcher.class);
   ...
   */
  @Deprecated
  public UserR1SignalFrequencyMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public UserR1SignalFrequencyMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a UserR1SignalFrequencyMatch object.
   * 
   */
  public Collection<UserR1SignalFrequencyMatch> getAllMatches(final String pVendor, final Signal pObject, final Integer pFrequency, final Composite pComposite) {
   ...
   * @param pFrequency the fixed value of pattern parameter frequency, or null if not bound.
   * @param pComposite the fixed value of pattern parameter composite, or null if not bound.
   * @return a match represented as a UserR1SignalFrequencyMatch object, or null if no match is found.
   * 
   */
  public UserR1SignalFrequencyMatch getOneArbitraryMatch(final String pVendor, final Signal pObject, final Integer pFrequency, final Composite pComposite) {
   ...
   * 
   */
  public void forEachMatch(final String pVendor, final Signal pObject, final Integer pFrequency, final Composite pComposite, final IMatchProcessor<? super UserR1SignalFrequencyMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pVendor, final Signal pObject, final Integer pFrequency, final Composite pComposite, final IMatchProcessor<? super UserR1SignalFrequencyMatch> processor) {
   ...
   * 
   */
  public UserR1SignalFrequencyMatch newMatch(final String pVendor, final Signal pObject, final Integer pFrequency, final Composite pComposite) {
    return UserR1SignalFrequencyMatch.newMatch(pVendor, pObject, pFrequency, pComposite);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfvendor(final UserR1SignalFrequencyMatch partialMatch) {
   ...
   * 
   */
  public Set<Signal> getAllValuesOfobject(final UserR1SignalFrequencyMatch partialMatch) {
   ...
   * 
   */
  public Set<Integer> getAllValuesOffrequency(final UserR1SignalFrequencyMatch partialMatch) {
   ...
   * 
   */
  public Set<Composite> getAllValuesOfcomposite(final UserR1SignalFrequencyMatch partialMatch) {
  ...
  @Override
  protected UserR1SignalFrequencyMatch tupleToMatch(final Tuple t) {
    try {
    	return UserR1SignalFrequencyMatch.newMatch((java.lang.String) t.get(POSITION_VENDOR), (wt.Signal) t.get(POSITION_OBJECT), (java.lang.Integer) t.get(POSITION_FREQUENCY), (wt.Composite) t.get(POSITION_COMPOSITE));
  ...
  @Override
  protected UserR1SignalFrequencyMatch arrayToMatch(final Object[] match) {
    try {
    	return UserR1SignalFrequencyMatch.newMatch((java.lang.String) match[POSITION_VENDOR], (wt.Signal) match[POSITION_OBJECT], (java.lang.Integer) match[POSITION_FREQUENCY], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected UserR1SignalFrequencyMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return UserR1SignalFrequencyMatch.newMutableMatch((java.lang.String) match[POSITION_VENDOR], (wt.Signal) match[POSITION_OBJECT], (java.lang.Integer) match[POSITION_FREQUENCY], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<UserR1SignalFrequencyMatcher> querySpecification() throws IncQueryException {
