...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.queries.userR1 pattern,
 * to be used in conjunction with {@link UserR1Matcher}.
 * 
...
public abstract class UserR1Match extends BasePatternMatch {
  ...
  private UserR1Match(final String pVendor, final Object pObject, final Composite pComposite) {
  ...
  public List<String> parameterNames() {
    return UserR1Match.parameterNames;
  }
  ...
  @Override
  public UserR1Match toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof UserR1Match)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    UserR1Match other = (UserR1Match) obj;
  ...
  @Override
  public UserR1QuerySpecification specification() {
    try {
   ...
   * 
   */
  public static UserR1Match newEmptyMatch() {
   ...
   * 
   */
  public static UserR1Match newMutableMatch(final String pVendor, final Object pObject, final Composite pComposite) {
   ...
   * 
   */
  public static UserR1Match newMatch(final String pVendor, final Object pObject, final Composite pComposite) {
    return new Immutable(pVendor, pObject, pComposite);
  }
  
  private static final class Mutable extends UserR1Match {
  ...
  private static final class Immutable extends UserR1Match {
