...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.queries.userR0ControlProvide pattern,
 * to be used in conjunction with {@link UserR0ControlProvideMatcher}.
 * 
...
public abstract class UserR0ControlProvideMatch extends BasePatternMatch {
  ...
  private UserR0ControlProvideMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
  ...
  public List<String> parameterNames() {
    return UserR0ControlProvideMatch.parameterNames;
  }
  ...
  @Override
  public UserR0ControlProvideMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof UserR0ControlProvideMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    UserR0ControlProvideMatch other = (UserR0ControlProvideMatch) obj;
  ...
  @Override
  public UserR0ControlProvideQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static UserR0ControlProvideMatch newEmptyMatch() {
   ...
   * 
   */
  public static UserR0ControlProvideMatch newMutableMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
   ...
   * 
   */
  public static UserR0ControlProvideMatch newMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
    return new Immutable(pVendor, pObject, pSignal, pComposite);
  }
  
  private static final class Mutable extends UserR0ControlProvideMatch {
  ...
  private static final class Immutable extends UserR0ControlProvideMatch {
