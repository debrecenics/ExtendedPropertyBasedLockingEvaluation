...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.queries.userRControlCycle pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link UserRControlCycleMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see UserRControlCycleProcessor
 * @see UserRControlCycleQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class UserRControlCycleMatcher extends BaseMatcher<UserRControlCycleMatch> {
  /**
   ...
   * 
   */
  public static UserRControlCycleMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    UserRControlCycleMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new UserRControlCycleMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(UserRControlCycleMatcher.class);
   ...
   */
  @Deprecated
  public UserRControlCycleMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public UserRControlCycleMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a UserRControlCycleMatch object.
   * 
   */
  public Collection<UserRControlCycleMatch> getAllMatches(final String pVendor, final Control pObject, final String pCycle, final Composite pComposite) {
   ...
   * @param pCycle the fixed value of pattern parameter cycle, or null if not bound.
   * @param pComposite the fixed value of pattern parameter composite, or null if not bound.
   * @return a match represented as a UserRControlCycleMatch object, or null if no match is found.
   * 
   */
  public UserRControlCycleMatch getOneArbitraryMatch(final String pVendor, final Control pObject, final String pCycle, final Composite pComposite) {
   ...
   * 
   */
  public void forEachMatch(final String pVendor, final Control pObject, final String pCycle, final Composite pComposite, final IMatchProcessor<? super UserRControlCycleMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pVendor, final Control pObject, final String pCycle, final Composite pComposite, final IMatchProcessor<? super UserRControlCycleMatch> processor) {
   ...
   * 
   */
  public UserRControlCycleMatch newMatch(final String pVendor, final Control pObject, final String pCycle, final Composite pComposite) {
    return UserRControlCycleMatch.newMatch(pVendor, pObject, pCycle, pComposite);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfvendor(final UserRControlCycleMatch partialMatch) {
   ...
   * 
   */
  public Set<Control> getAllValuesOfobject(final UserRControlCycleMatch partialMatch) {
   ...
   * 
   */
  public Set<String> getAllValuesOfcycle(final UserRControlCycleMatch partialMatch) {
   ...
   * 
   */
  public Set<Composite> getAllValuesOfcomposite(final UserRControlCycleMatch partialMatch) {
  ...
  @Override
  protected UserRControlCycleMatch tupleToMatch(final Tuple t) {
    try {
    	return UserRControlCycleMatch.newMatch((java.lang.String) t.get(POSITION_VENDOR), (wt.Control) t.get(POSITION_OBJECT), (java.lang.String) t.get(POSITION_CYCLE), (wt.Composite) t.get(POSITION_COMPOSITE));
  ...
  @Override
  protected UserRControlCycleMatch arrayToMatch(final Object[] match) {
    try {
    	return UserRControlCycleMatch.newMatch((java.lang.String) match[POSITION_VENDOR], (wt.Control) match[POSITION_OBJECT], (java.lang.String) match[POSITION_CYCLE], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected UserRControlCycleMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return UserRControlCycleMatch.newMutableMatch((java.lang.String) match[POSITION_VENDOR], (wt.Control) match[POSITION_OBJECT], (java.lang.String) match[POSITION_CYCLE], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<UserRControlCycleMatcher> querySpecification() throws IncQueryException {
