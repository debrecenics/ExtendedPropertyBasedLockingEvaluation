...
import org.mondo.collaboration.queries.UserR1ControlConsumeMatch;
...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.queries.userR1ControlConsume pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link UserR1ControlConsumeMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * </pre></code>
 * 
 * @see UserR1ControlConsumeMatch
 * @see UserR1ControlConsumeProcessor
 * @see UserR1ControlConsumeQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class UserR1ControlConsumeMatcher extends BaseMatcher<UserR1ControlConsumeMatch> {
  /**
   ...
   * 
   */
  public static UserR1ControlConsumeMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    UserR1ControlConsumeMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new UserR1ControlConsumeMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(UserR1ControlConsumeMatcher.class);
   ...
   */
  @Deprecated
  public UserR1ControlConsumeMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public UserR1ControlConsumeMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a UserR1ControlConsumeMatch object.
   * 
   */
  public Collection<UserR1ControlConsumeMatch> getAllMatches(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
   ...
   * @param pSignal the fixed value of pattern parameter signal, or null if not bound.
   * @param pComposite the fixed value of pattern parameter composite, or null if not bound.
   * @return a match represented as a UserR1ControlConsumeMatch object, or null if no match is found.
   * 
   */
  public UserR1ControlConsumeMatch getOneArbitraryMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
   ...
   * 
   */
  public void forEachMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite, final IMatchProcessor<? super UserR1ControlConsumeMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite, final IMatchProcessor<? super UserR1ControlConsumeMatch> processor) {
   ...
   * 
   */
  public UserR1ControlConsumeMatch newMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
    return UserR1ControlConsumeMatch.newMatch(pVendor, pObject, pSignal, pComposite);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfvendor(final UserR1ControlConsumeMatch partialMatch) {
   ...
   * 
   */
  public Set<Control> getAllValuesOfobject(final UserR1ControlConsumeMatch partialMatch) {
   ...
   * 
   */
  public Set<Signal> getAllValuesOfsignal(final UserR1ControlConsumeMatch partialMatch) {
   ...
   * 
   */
  public Set<Composite> getAllValuesOfcomposite(final UserR1ControlConsumeMatch partialMatch) {
  ...
  @Override
  protected UserR1ControlConsumeMatch tupleToMatch(final Tuple t) {
    try {
    	return UserR1ControlConsumeMatch.newMatch((java.lang.String) t.get(POSITION_VENDOR), (wt.Control) t.get(POSITION_OBJECT), (wt.Signal) t.get(POSITION_SIGNAL), (wt.Composite) t.get(POSITION_COMPOSITE));
  ...
  @Override
  protected UserR1ControlConsumeMatch arrayToMatch(final Object[] match) {
    try {
    	return UserR1ControlConsumeMatch.newMatch((java.lang.String) match[POSITION_VENDOR], (wt.Control) match[POSITION_OBJECT], (wt.Signal) match[POSITION_SIGNAL], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected UserR1ControlConsumeMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return UserR1ControlConsumeMatch.newMutableMatch((java.lang.String) match[POSITION_VENDOR], (wt.Control) match[POSITION_OBJECT], (wt.Signal) match[POSITION_SIGNAL], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<UserR1ControlConsumeMatcher> querySpecification() throws IncQueryException {
