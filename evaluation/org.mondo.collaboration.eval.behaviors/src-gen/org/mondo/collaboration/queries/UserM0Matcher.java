...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.queries.userM0 pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link UserM0Match}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see UserM0Match
 * @see UserM0Processor
 * @see UserM0QuerySpecification
 * 
 */
@SuppressWarnings("all")
public class UserM0Matcher extends BaseMatcher<UserM0Match> {
  /**
   ...
   * 
   */
  public static UserM0Matcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    UserM0Matcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new UserM0Matcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(UserM0Matcher.class);
   ...
   */
  @Deprecated
  public UserM0Matcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public UserM0Matcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a UserM0Match object.
   * 
   */
  public Collection<UserM0Match> getAllMatches(final Control pCtrl, final Signal pSgn, final Integer pF) {
   ...
   * @param pSgn the fixed value of pattern parameter sgn, or null if not bound.
   * @param pF the fixed value of pattern parameter f, or null if not bound.
   * @return a match represented as a UserM0Match object, or null if no match is found.
   * 
   */
  public UserM0Match getOneArbitraryMatch(final Control pCtrl, final Signal pSgn, final Integer pF) {
   ...
   * 
   */
  public void forEachMatch(final Control pCtrl, final Signal pSgn, final Integer pF, final IMatchProcessor<? super UserM0Match> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Control pCtrl, final Signal pSgn, final Integer pF, final IMatchProcessor<? super UserM0Match> processor) {
   ...
   * 
   */
  public UserM0Match newMatch(final Control pCtrl, final Signal pSgn, final Integer pF) {
    return UserM0Match.newMatch(pCtrl, pSgn, pF);
  }
   ...
   * 
   */
  public Set<Control> getAllValuesOfctrl(final UserM0Match partialMatch) {
   ...
   * 
   */
  public Set<Signal> getAllValuesOfsgn(final UserM0Match partialMatch) {
   ...
   * 
   */
  public Set<Integer> getAllValuesOff(final UserM0Match partialMatch) {
  ...
  @Override
  protected UserM0Match tupleToMatch(final Tuple t) {
    try {
    	return UserM0Match.newMatch((wt.Control) t.get(POSITION_CTRL), (wt.Signal) t.get(POSITION_SGN), (java.lang.Integer) t.get(POSITION_F));
  ...
  @Override
  protected UserM0Match arrayToMatch(final Object[] match) {
    try {
    	return UserM0Match.newMatch((wt.Control) match[POSITION_CTRL], (wt.Signal) match[POSITION_SGN], (java.lang.Integer) match[POSITION_F]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected UserM0Match arrayToMatchMutable(final Object[] match) {
    try {
    	return UserM0Match.newMutableMatch((wt.Control) match[POSITION_CTRL], (wt.Signal) match[POSITION_SGN], (java.lang.Integer) match[POSITION_F]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<UserM0Matcher> querySpecification() throws IncQueryException {
