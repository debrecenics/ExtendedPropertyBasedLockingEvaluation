...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.queries.userR1ControlCycle pattern,
 * to be used in conjunction with {@link UserR1ControlCycleMatcher}.
 * 
 ...
 * 
 * @see UserR1ControlCycleMatcher
 * @see UserR1ControlCycleProcessor
 * 
 */
@SuppressWarnings("all")
public abstract class UserR1ControlCycleMatch extends BasePatternMatch {
  ...
  private UserR1ControlCycleMatch(final String pVendor, final Control pObject, final String pCycle, final Composite pComposite) {
  ...
  public String patternName() {
    return "org.mondo.collaboration.queries.userR1ControlCycle";
  }
  
  @Override
  public List<String> parameterNames() {
    return UserR1ControlCycleMatch.parameterNames;
  }
  ...
  @Override
  public UserR1ControlCycleMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof UserR1ControlCycleMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    UserR1ControlCycleMatch other = (UserR1ControlCycleMatch) obj;
  ...
  @Override
  public UserR1ControlCycleQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static UserR1ControlCycleMatch newEmptyMatch() {
   ...
   * 
   */
  public static UserR1ControlCycleMatch newMutableMatch(final String pVendor, final Control pObject, final String pCycle, final Composite pComposite) {
   ...
   * 
   */
  public static UserR1ControlCycleMatch newMatch(final String pVendor, final Control pObject, final String pCycle, final Composite pComposite) {
    return new Immutable(pVendor, pObject, pCycle, pComposite);
  }
  
  private static final class Mutable extends UserR1ControlCycleMatch {
  ...
  private static final class Immutable extends UserR1ControlCycleMatch {
