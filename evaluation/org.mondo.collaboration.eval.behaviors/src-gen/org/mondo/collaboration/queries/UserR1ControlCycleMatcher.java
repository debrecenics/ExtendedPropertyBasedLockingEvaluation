...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.queries.userR1ControlCycle pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link UserR1ControlCycleMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * </pre></code>
 * 
 * @see UserR1ControlCycleMatch
 * @see UserR1ControlCycleProcessor
 * @see UserR1ControlCycleQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class UserR1ControlCycleMatcher extends BaseMatcher<UserR1ControlCycleMatch> {
  /**
   ...
   * 
   */
  public static UserR1ControlCycleMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    UserR1ControlCycleMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new UserR1ControlCycleMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(UserR1ControlCycleMatcher.class);
   ...
   */
  @Deprecated
  public UserR1ControlCycleMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public UserR1ControlCycleMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a UserR1ControlCycleMatch object.
   * 
   */
  public Collection<UserR1ControlCycleMatch> getAllMatches(final String pVendor, final Control pObject, final String pCycle, final Composite pComposite) {
   ...
   * @param pCycle the fixed value of pattern parameter cycle, or null if not bound.
   * @param pComposite the fixed value of pattern parameter composite, or null if not bound.
   * @return a match represented as a UserR1ControlCycleMatch object, or null if no match is found.
   * 
   */
  public UserR1ControlCycleMatch getOneArbitraryMatch(final String pVendor, final Control pObject, final String pCycle, final Composite pComposite) {
   ...
   * 
   */
  public void forEachMatch(final String pVendor, final Control pObject, final String pCycle, final Composite pComposite, final IMatchProcessor<? super UserR1ControlCycleMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pVendor, final Control pObject, final String pCycle, final Composite pComposite, final IMatchProcessor<? super UserR1ControlCycleMatch> processor) {
   ...
   * 
   */
  public UserR1ControlCycleMatch newMatch(final String pVendor, final Control pObject, final String pCycle, final Composite pComposite) {
    return UserR1ControlCycleMatch.newMatch(pVendor, pObject, pCycle, pComposite);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfvendor(final UserR1ControlCycleMatch partialMatch) {
   ...
   * 
   */
  public Set<Control> getAllValuesOfobject(final UserR1ControlCycleMatch partialMatch) {
   ...
   * 
   */
  public Set<String> getAllValuesOfcycle(final UserR1ControlCycleMatch partialMatch) {
   ...
   * 
   */
  public Set<Composite> getAllValuesOfcomposite(final UserR1ControlCycleMatch partialMatch) {
  ...
  @Override
  protected UserR1ControlCycleMatch tupleToMatch(final Tuple t) {
    try {
    	return UserR1ControlCycleMatch.newMatch((java.lang.String) t.get(POSITION_VENDOR), (wt.Control) t.get(POSITION_OBJECT), (java.lang.String) t.get(POSITION_CYCLE), (wt.Composite) t.get(POSITION_COMPOSITE));
  ...
  @Override
  protected UserR1ControlCycleMatch arrayToMatch(final Object[] match) {
    try {
    	return UserR1ControlCycleMatch.newMatch((java.lang.String) match[POSITION_VENDOR], (wt.Control) match[POSITION_OBJECT], (java.lang.String) match[POSITION_CYCLE], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected UserR1ControlCycleMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return UserR1ControlCycleMatch.newMutableMatch((java.lang.String) match[POSITION_VENDOR], (wt.Control) match[POSITION_OBJECT], (java.lang.String) match[POSITION_CYCLE], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<UserR1ControlCycleMatcher> querySpecification() throws IncQueryException {
