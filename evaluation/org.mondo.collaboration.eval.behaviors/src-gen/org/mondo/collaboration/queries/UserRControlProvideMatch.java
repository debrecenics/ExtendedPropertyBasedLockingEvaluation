...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.queries.userRControlProvide pattern,
 * to be used in conjunction with {@link UserRControlProvideMatcher}.
 * 
 ...
 * 
 * @see UserRControlProvideMatcher
 * @see UserRControlProvideProcessor
 * 
 */
@SuppressWarnings("all")
public abstract class UserRControlProvideMatch extends BasePatternMatch {
  ...
  private UserRControlProvideMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
  ...
  public String patternName() {
    return "org.mondo.collaboration.queries.userRControlProvide";
  }
  
  @Override
  public List<String> parameterNames() {
    return UserRControlProvideMatch.parameterNames;
  }
  ...
  @Override
  public UserRControlProvideMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof UserRControlProvideMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    UserRControlProvideMatch other = (UserRControlProvideMatch) obj;
  ...
  @Override
  public UserRControlProvideQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static UserRControlProvideMatch newEmptyMatch() {
   ...
   * 
   */
  public static UserRControlProvideMatch newMutableMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
   ...
   * 
   */
  public static UserRControlProvideMatch newMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
    return new Immutable(pVendor, pObject, pSignal, pComposite);
  }
  
  private static final class Mutable extends UserRControlProvideMatch {
  ...
  private static final class Immutable extends UserRControlProvideMatch {
