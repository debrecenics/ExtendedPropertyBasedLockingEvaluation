...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.queries.userR1ControlType pattern,
 * to be used in conjunction with {@link UserR1ControlTypeMatcher}.
 * 
...
public abstract class UserR1ControlTypeMatch extends BasePatternMatch {
  ...
  private UserR1ControlTypeMatch(final String pVendor, final Control pObject, final String pType, final Composite pComposite) {
  ...
  public List<String> parameterNames() {
    return UserR1ControlTypeMatch.parameterNames;
  }
  ...
  @Override
  public UserR1ControlTypeMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof UserR1ControlTypeMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    UserR1ControlTypeMatch other = (UserR1ControlTypeMatch) obj;
  ...
  @Override
  public UserR1ControlTypeQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static UserR1ControlTypeMatch newEmptyMatch() {
   ...
   * 
   */
  public static UserR1ControlTypeMatch newMutableMatch(final String pVendor, final Control pObject, final String pType, final Composite pComposite) {
   ...
   * 
   */
  public static UserR1ControlTypeMatch newMatch(final String pVendor, final Control pObject, final String pType, final Composite pComposite) {
    return new Immutable(pVendor, pObject, pType, pComposite);
  }
  
  private static final class Mutable extends UserR1ControlTypeMatch {
  ...
  private static final class Immutable extends UserR1ControlTypeMatch {
