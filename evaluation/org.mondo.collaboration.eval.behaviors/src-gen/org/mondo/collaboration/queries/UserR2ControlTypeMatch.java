...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.queries.userR2ControlType pattern,
 * to be used in conjunction with {@link UserR2ControlTypeMatcher}.
 * 
 ...
 * 
 * @see UserR2ControlTypeMatcher
 * @see UserR2ControlTypeProcessor
 * 
 */
@SuppressWarnings("all")
public abstract class UserR2ControlTypeMatch extends BasePatternMatch {
  ...
  private UserR2ControlTypeMatch(final String pVendor, final Control pObject, final String pType, final Composite pComposite) {
  ...
  public String patternName() {
    return "org.mondo.collaboration.queries.userR2ControlType";
  }
  
  @Override
  public List<String> parameterNames() {
    return UserR2ControlTypeMatch.parameterNames;
  }
  ...
  @Override
  public UserR2ControlTypeMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof UserR2ControlTypeMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    UserR2ControlTypeMatch other = (UserR2ControlTypeMatch) obj;
  ...
  @Override
  public UserR2ControlTypeQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static UserR2ControlTypeMatch newEmptyMatch() {
   ...
   * 
   */
  public static UserR2ControlTypeMatch newMutableMatch(final String pVendor, final Control pObject, final String pType, final Composite pComposite) {
   ...
   * 
   */
  public static UserR2ControlTypeMatch newMatch(final String pVendor, final Control pObject, final String pType, final Composite pComposite) {
    return new Immutable(pVendor, pObject, pType, pComposite);
  }
  
  private static final class Mutable extends UserR2ControlTypeMatch {
  ...
  private static final class Immutable extends UserR2ControlTypeMatch {
