...
import org.mondo.collaboration.queries.UserR1ControlTypeMatch;
import org.mondo.collaboration.queries.util.UserR1ControlTypeQuerySpecification;
import wt.Composite;
import wt.Control;

/**
 * Generated pattern matcher API of the org.mondo.collaboration.queries.userR1ControlType pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link UserR1ControlTypeMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * </pre></code>
 * 
 * @see UserR1ControlTypeMatch
 * @see UserR1ControlTypeProcessor
 * @see UserR1ControlTypeQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class UserR1ControlTypeMatcher extends BaseMatcher<UserR1ControlTypeMatch> {
  /**
   ...
   * 
   */
  public static UserR1ControlTypeMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    UserR1ControlTypeMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new UserR1ControlTypeMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(UserR1ControlTypeMatcher.class);
   ...
   */
  @Deprecated
  public UserR1ControlTypeMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public UserR1ControlTypeMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a UserR1ControlTypeMatch object.
   * 
   */
  public Collection<UserR1ControlTypeMatch> getAllMatches(final String pVendor, final Control pObject, final String pType, final Composite pComposite) {
   ...
   * @param pType the fixed value of pattern parameter type, or null if not bound.
   * @param pComposite the fixed value of pattern parameter composite, or null if not bound.
   * @return a match represented as a UserR1ControlTypeMatch object, or null if no match is found.
   * 
   */
  public UserR1ControlTypeMatch getOneArbitraryMatch(final String pVendor, final Control pObject, final String pType, final Composite pComposite) {
   ...
   * 
   */
  public void forEachMatch(final String pVendor, final Control pObject, final String pType, final Composite pComposite, final IMatchProcessor<? super UserR1ControlTypeMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pVendor, final Control pObject, final String pType, final Composite pComposite, final IMatchProcessor<? super UserR1ControlTypeMatch> processor) {
   ...
   * 
   */
  public UserR1ControlTypeMatch newMatch(final String pVendor, final Control pObject, final String pType, final Composite pComposite) {
    return UserR1ControlTypeMatch.newMatch(pVendor, pObject, pType, pComposite);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfvendor(final UserR1ControlTypeMatch partialMatch) {
   ...
   * 
   */
  public Set<Control> getAllValuesOfobject(final UserR1ControlTypeMatch partialMatch) {
   ...
   * 
   */
  public Set<String> getAllValuesOftype(final UserR1ControlTypeMatch partialMatch) {
   ...
   * 
   */
  public Set<Composite> getAllValuesOfcomposite(final UserR1ControlTypeMatch partialMatch) {
  ...
  @Override
  protected UserR1ControlTypeMatch tupleToMatch(final Tuple t) {
    try {
    	return UserR1ControlTypeMatch.newMatch((java.lang.String) t.get(POSITION_VENDOR), (wt.Control) t.get(POSITION_OBJECT), (java.lang.String) t.get(POSITION_TYPE), (wt.Composite) t.get(POSITION_COMPOSITE));
  ...
  @Override
  protected UserR1ControlTypeMatch arrayToMatch(final Object[] match) {
    try {
    	return UserR1ControlTypeMatch.newMatch((java.lang.String) match[POSITION_VENDOR], (wt.Control) match[POSITION_OBJECT], (java.lang.String) match[POSITION_TYPE], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected UserR1ControlTypeMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return UserR1ControlTypeMatch.newMutableMatch((java.lang.String) match[POSITION_VENDOR], (wt.Control) match[POSITION_OBJECT], (java.lang.String) match[POSITION_TYPE], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<UserR1ControlTypeMatcher> querySpecification() throws IncQueryException {
