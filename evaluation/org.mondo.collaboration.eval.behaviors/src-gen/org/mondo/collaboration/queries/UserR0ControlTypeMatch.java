...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.queries.userR0ControlType pattern,
 * to be used in conjunction with {@link UserR0ControlTypeMatcher}.
 * 
...
public abstract class UserR0ControlTypeMatch extends BasePatternMatch {
  ...
  private UserR0ControlTypeMatch(final String pVendor, final Control pObject, final String pType, final Composite pComposite) {
  ...
  public List<String> parameterNames() {
    return UserR0ControlTypeMatch.parameterNames;
  }
  ...
  @Override
  public UserR0ControlTypeMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof UserR0ControlTypeMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    UserR0ControlTypeMatch other = (UserR0ControlTypeMatch) obj;
  ...
  @Override
  public UserR0ControlTypeQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static UserR0ControlTypeMatch newEmptyMatch() {
   ...
   * 
   */
  public static UserR0ControlTypeMatch newMutableMatch(final String pVendor, final Control pObject, final String pType, final Composite pComposite) {
   ...
   * 
   */
  public static UserR0ControlTypeMatch newMatch(final String pVendor, final Control pObject, final String pType, final Composite pComposite) {
    return new Immutable(pVendor, pObject, pType, pComposite);
  }
  
  private static final class Mutable extends UserR0ControlTypeMatch {
  ...
  private static final class Immutable extends UserR0ControlTypeMatch {
