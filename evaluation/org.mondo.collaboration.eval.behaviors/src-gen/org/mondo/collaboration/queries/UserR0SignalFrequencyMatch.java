...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.queries.userR0SignalFrequency pattern,
 * to be used in conjunction with {@link UserR0SignalFrequencyMatcher}.
 * 
 ...
 * 
 * @see UserR0SignalFrequencyMatcher
 * @see UserR0SignalFrequencyProcessor
 * 
 */
@SuppressWarnings("all")
public abstract class UserR0SignalFrequencyMatch extends BasePatternMatch {
  ...
  private UserR0SignalFrequencyMatch(final String pVendor, final Signal pObject, final Integer pFrequency, final Composite pComposite) {
  ...
  public String patternName() {
    return "org.mondo.collaboration.queries.userR0SignalFrequency";
  }
  
  @Override
  public List<String> parameterNames() {
    return UserR0SignalFrequencyMatch.parameterNames;
  }
  ...
  @Override
  public UserR0SignalFrequencyMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof UserR0SignalFrequencyMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    UserR0SignalFrequencyMatch other = (UserR0SignalFrequencyMatch) obj;
  ...
  @Override
  public UserR0SignalFrequencyQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static UserR0SignalFrequencyMatch newEmptyMatch() {
   ...
   * 
   */
  public static UserR0SignalFrequencyMatch newMutableMatch(final String pVendor, final Signal pObject, final Integer pFrequency, final Composite pComposite) {
   ...
   * 
   */
  public static UserR0SignalFrequencyMatch newMatch(final String pVendor, final Signal pObject, final Integer pFrequency, final Composite pComposite) {
    return new Immutable(pVendor, pObject, pFrequency, pComposite);
  }
  
  private static final class Mutable extends UserR0SignalFrequencyMatch {
  ...
  private static final class Immutable extends UserR0SignalFrequencyMatch {
