...
import org.mondo.collaboration.queries.UserR2ControlConsumeMatch;
...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.queries.userR2ControlConsume pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link UserR2ControlConsumeMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * </pre></code>
 * 
 * @see UserR2ControlConsumeMatch
 * @see UserR2ControlConsumeProcessor
 * @see UserR2ControlConsumeQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class UserR2ControlConsumeMatcher extends BaseMatcher<UserR2ControlConsumeMatch> {
  /**
   ...
   * 
   */
  public static UserR2ControlConsumeMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    UserR2ControlConsumeMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new UserR2ControlConsumeMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(UserR2ControlConsumeMatcher.class);
   ...
   */
  @Deprecated
  public UserR2ControlConsumeMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public UserR2ControlConsumeMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a UserR2ControlConsumeMatch object.
   * 
   */
  public Collection<UserR2ControlConsumeMatch> getAllMatches(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
   ...
   * @param pSignal the fixed value of pattern parameter signal, or null if not bound.
   * @param pComposite the fixed value of pattern parameter composite, or null if not bound.
   * @return a match represented as a UserR2ControlConsumeMatch object, or null if no match is found.
   * 
   */
  public UserR2ControlConsumeMatch getOneArbitraryMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
   ...
   * 
   */
  public void forEachMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite, final IMatchProcessor<? super UserR2ControlConsumeMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite, final IMatchProcessor<? super UserR2ControlConsumeMatch> processor) {
   ...
   * 
   */
  public UserR2ControlConsumeMatch newMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
    return UserR2ControlConsumeMatch.newMatch(pVendor, pObject, pSignal, pComposite);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfvendor(final UserR2ControlConsumeMatch partialMatch) {
   ...
   * 
   */
  public Set<Control> getAllValuesOfobject(final UserR2ControlConsumeMatch partialMatch) {
   ...
   * 
   */
  public Set<Signal> getAllValuesOfsignal(final UserR2ControlConsumeMatch partialMatch) {
   ...
   * 
   */
  public Set<Composite> getAllValuesOfcomposite(final UserR2ControlConsumeMatch partialMatch) {
  ...
  @Override
  protected UserR2ControlConsumeMatch tupleToMatch(final Tuple t) {
    try {
    	return UserR2ControlConsumeMatch.newMatch((java.lang.String) t.get(POSITION_VENDOR), (wt.Control) t.get(POSITION_OBJECT), (wt.Signal) t.get(POSITION_SIGNAL), (wt.Composite) t.get(POSITION_COMPOSITE));
  ...
  @Override
  protected UserR2ControlConsumeMatch arrayToMatch(final Object[] match) {
    try {
    	return UserR2ControlConsumeMatch.newMatch((java.lang.String) match[POSITION_VENDOR], (wt.Control) match[POSITION_OBJECT], (wt.Signal) match[POSITION_SIGNAL], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected UserR2ControlConsumeMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return UserR2ControlConsumeMatch.newMutableMatch((java.lang.String) match[POSITION_VENDOR], (wt.Control) match[POSITION_OBJECT], (wt.Signal) match[POSITION_SIGNAL], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<UserR2ControlConsumeMatcher> querySpecification() throws IncQueryException {
