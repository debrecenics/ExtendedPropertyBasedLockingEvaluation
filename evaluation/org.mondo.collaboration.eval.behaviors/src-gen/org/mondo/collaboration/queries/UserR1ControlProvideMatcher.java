...
import org.mondo.collaboration.queries.UserR1ControlProvideMatch;
...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.queries.userR1ControlProvide pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link UserR1ControlProvideMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * </pre></code>
 * 
 * @see UserR1ControlProvideMatch
 * @see UserR1ControlProvideProcessor
 * @see UserR1ControlProvideQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class UserR1ControlProvideMatcher extends BaseMatcher<UserR1ControlProvideMatch> {
  /**
   ...
   * 
   */
  public static UserR1ControlProvideMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    UserR1ControlProvideMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new UserR1ControlProvideMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(UserR1ControlProvideMatcher.class);
   ...
   */
  @Deprecated
  public UserR1ControlProvideMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public UserR1ControlProvideMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a UserR1ControlProvideMatch object.
   * 
   */
  public Collection<UserR1ControlProvideMatch> getAllMatches(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
   ...
   * @param pSignal the fixed value of pattern parameter signal, or null if not bound.
   * @param pComposite the fixed value of pattern parameter composite, or null if not bound.
   * @return a match represented as a UserR1ControlProvideMatch object, or null if no match is found.
   * 
   */
  public UserR1ControlProvideMatch getOneArbitraryMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
   ...
   * 
   */
  public void forEachMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite, final IMatchProcessor<? super UserR1ControlProvideMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite, final IMatchProcessor<? super UserR1ControlProvideMatch> processor) {
   ...
   * 
   */
  public UserR1ControlProvideMatch newMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
    return UserR1ControlProvideMatch.newMatch(pVendor, pObject, pSignal, pComposite);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfvendor(final UserR1ControlProvideMatch partialMatch) {
   ...
   * 
   */
  public Set<Control> getAllValuesOfobject(final UserR1ControlProvideMatch partialMatch) {
   ...
   * 
   */
  public Set<Signal> getAllValuesOfsignal(final UserR1ControlProvideMatch partialMatch) {
   ...
   * 
   */
  public Set<Composite> getAllValuesOfcomposite(final UserR1ControlProvideMatch partialMatch) {
  ...
  @Override
  protected UserR1ControlProvideMatch tupleToMatch(final Tuple t) {
    try {
    	return UserR1ControlProvideMatch.newMatch((java.lang.String) t.get(POSITION_VENDOR), (wt.Control) t.get(POSITION_OBJECT), (wt.Signal) t.get(POSITION_SIGNAL), (wt.Composite) t.get(POSITION_COMPOSITE));
  ...
  @Override
  protected UserR1ControlProvideMatch arrayToMatch(final Object[] match) {
    try {
    	return UserR1ControlProvideMatch.newMatch((java.lang.String) match[POSITION_VENDOR], (wt.Control) match[POSITION_OBJECT], (wt.Signal) match[POSITION_SIGNAL], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected UserR1ControlProvideMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return UserR1ControlProvideMatch.newMutableMatch((java.lang.String) match[POSITION_VENDOR], (wt.Control) match[POSITION_OBJECT], (wt.Signal) match[POSITION_SIGNAL], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<UserR1ControlProvideMatcher> querySpecification() throws IncQueryException {
