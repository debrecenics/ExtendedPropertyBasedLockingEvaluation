...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.queries.userR0ControlCycle pattern,
 * to be used in conjunction with {@link UserR0ControlCycleMatcher}.
 * 
 ...
 * 
 * @see UserR0ControlCycleMatcher
 * @see UserR0ControlCycleProcessor
 * 
 */
@SuppressWarnings("all")
public abstract class UserR0ControlCycleMatch extends BasePatternMatch {
  ...
  private UserR0ControlCycleMatch(final String pVendor, final Control pObject, final String pCycle, final Composite pComposite) {
  ...
  public String patternName() {
    return "org.mondo.collaboration.queries.userR0ControlCycle";
  }
  
  @Override
  public List<String> parameterNames() {
    return UserR0ControlCycleMatch.parameterNames;
  }
  ...
  @Override
  public UserR0ControlCycleMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof UserR0ControlCycleMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    UserR0ControlCycleMatch other = (UserR0ControlCycleMatch) obj;
  ...
  @Override
  public UserR0ControlCycleQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static UserR0ControlCycleMatch newEmptyMatch() {
   ...
   * 
   */
  public static UserR0ControlCycleMatch newMutableMatch(final String pVendor, final Control pObject, final String pCycle, final Composite pComposite) {
   ...
   * 
   */
  public static UserR0ControlCycleMatch newMatch(final String pVendor, final Control pObject, final String pCycle, final Composite pComposite) {
    return new Immutable(pVendor, pObject, pCycle, pComposite);
  }
  
  private static final class Mutable extends UserR0ControlCycleMatch {
  ...
  private static final class Immutable extends UserR0ControlCycleMatch {
