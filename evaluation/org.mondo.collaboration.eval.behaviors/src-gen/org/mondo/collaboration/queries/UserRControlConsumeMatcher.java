...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.queries.userRControlConsume pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link UserRControlConsumeMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see UserRControlConsumeProcessor
 * @see UserRControlConsumeQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class UserRControlConsumeMatcher extends BaseMatcher<UserRControlConsumeMatch> {
  /**
   ...
   * 
   */
  public static UserRControlConsumeMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    UserRControlConsumeMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new UserRControlConsumeMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(UserRControlConsumeMatcher.class);
   ...
   */
  @Deprecated
  public UserRControlConsumeMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public UserRControlConsumeMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a UserRControlConsumeMatch object.
   * 
   */
  public Collection<UserRControlConsumeMatch> getAllMatches(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
   ...
   * @param pSignal the fixed value of pattern parameter signal, or null if not bound.
   * @param pComposite the fixed value of pattern parameter composite, or null if not bound.
   * @return a match represented as a UserRControlConsumeMatch object, or null if no match is found.
   * 
   */
  public UserRControlConsumeMatch getOneArbitraryMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
   ...
   * 
   */
  public void forEachMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite, final IMatchProcessor<? super UserRControlConsumeMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite, final IMatchProcessor<? super UserRControlConsumeMatch> processor) {
   ...
   * 
   */
  public UserRControlConsumeMatch newMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
    return UserRControlConsumeMatch.newMatch(pVendor, pObject, pSignal, pComposite);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfvendor(final UserRControlConsumeMatch partialMatch) {
   ...
   * 
   */
  public Set<Control> getAllValuesOfobject(final UserRControlConsumeMatch partialMatch) {
   ...
   * 
   */
  public Set<Signal> getAllValuesOfsignal(final UserRControlConsumeMatch partialMatch) {
   ...
   * 
   */
  public Set<Composite> getAllValuesOfcomposite(final UserRControlConsumeMatch partialMatch) {
  ...
  @Override
  protected UserRControlConsumeMatch tupleToMatch(final Tuple t) {
    try {
    	return UserRControlConsumeMatch.newMatch((java.lang.String) t.get(POSITION_VENDOR), (wt.Control) t.get(POSITION_OBJECT), (wt.Signal) t.get(POSITION_SIGNAL), (wt.Composite) t.get(POSITION_COMPOSITE));
  ...
  @Override
  protected UserRControlConsumeMatch arrayToMatch(final Object[] match) {
    try {
    	return UserRControlConsumeMatch.newMatch((java.lang.String) match[POSITION_VENDOR], (wt.Control) match[POSITION_OBJECT], (wt.Signal) match[POSITION_SIGNAL], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected UserRControlConsumeMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return UserRControlConsumeMatch.newMutableMatch((java.lang.String) match[POSITION_VENDOR], (wt.Control) match[POSITION_OBJECT], (wt.Signal) match[POSITION_SIGNAL], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<UserRControlConsumeMatcher> querySpecification() throws IncQueryException {
