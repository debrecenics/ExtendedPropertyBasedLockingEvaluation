...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.queries.userR pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link UserRMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see UserRMatch
 * @see UserRProcessor
 * @see UserRQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class UserRMatcher extends BaseMatcher<UserRMatch> {
  /**
   ...
   * 
   */
  public static UserRMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    UserRMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new UserRMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(UserRMatcher.class);
   ...
   */
  @Deprecated
  public UserRMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public UserRMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a UserRMatch object.
   * 
   */
  public Collection<UserRMatch> getAllMatches(final String pVendor, final Object pObject, final Composite pComposite) {
   ...
   * @param pObject the fixed value of pattern parameter object, or null if not bound.
   * @param pComposite the fixed value of pattern parameter composite, or null if not bound.
   * @return a match represented as a UserRMatch object, or null if no match is found.
   * 
   */
  public UserRMatch getOneArbitraryMatch(final String pVendor, final Object pObject, final Composite pComposite) {
   ...
   * 
   */
  public void forEachMatch(final String pVendor, final Object pObject, final Composite pComposite, final IMatchProcessor<? super UserRMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pVendor, final Object pObject, final Composite pComposite, final IMatchProcessor<? super UserRMatch> processor) {
   ...
   * 
   */
  public UserRMatch newMatch(final String pVendor, final Object pObject, final Composite pComposite) {
    return UserRMatch.newMatch(pVendor, pObject, pComposite);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfvendor(final UserRMatch partialMatch) {
   ...
   * 
   */
  public Set<Object> getAllValuesOfobject(final UserRMatch partialMatch) {
   ...
   * 
   */
  public Set<Composite> getAllValuesOfcomposite(final UserRMatch partialMatch) {
  ...
  @Override
  protected UserRMatch tupleToMatch(final Tuple t) {
    try {
    	return UserRMatch.newMatch((java.lang.String) t.get(POSITION_VENDOR), (java.lang.Object) t.get(POSITION_OBJECT), (wt.Composite) t.get(POSITION_COMPOSITE));
  ...
  @Override
  protected UserRMatch arrayToMatch(final Object[] match) {
    try {
    	return UserRMatch.newMatch((java.lang.String) match[POSITION_VENDOR], (java.lang.Object) match[POSITION_OBJECT], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected UserRMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return UserRMatch.newMutableMatch((java.lang.String) match[POSITION_VENDOR], (java.lang.Object) match[POSITION_OBJECT], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<UserRMatcher> querySpecification() throws IncQueryException {
