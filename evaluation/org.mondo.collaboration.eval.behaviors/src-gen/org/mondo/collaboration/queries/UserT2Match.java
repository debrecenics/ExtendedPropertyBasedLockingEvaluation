...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.queries.userT2 pattern,
 * to be used in conjunction with {@link UserT2Matcher}.
 * 
...
public abstract class UserT2Match extends BasePatternMatch {
  ...
  private UserT2Match(final Control pCtrl, final Signal pSgn, final String pC, final String pT) {
    this.fCtrl = pCtrl;
    this.fSgn = pSgn;
    this.fC = pC;
    this.fT = pT;
  ...
  public List<String> parameterNames() {
    return UserT2Match.parameterNames;
  }
  ...
  @Override
  public UserT2Match toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof UserT2Match)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    UserT2Match other = (UserT2Match) obj;
  ...
  @Override
  public UserT2QuerySpecification specification() {
    try {
   ...
   * 
   */
  public static UserT2Match newEmptyMatch() {
   ...
   * 
   */
  public static UserT2Match newMutableMatch(final Control pCtrl, final Signal pSgn, final String pC, final String pT) {
   ...
   * 
   */
  public static UserT2Match newMatch(final Control pCtrl, final Signal pSgn, final String pC, final String pT) {
    return new Immutable(pCtrl, pSgn, pC, pT);
  }
  
  private static final class Mutable extends UserT2Match {
  ...
  private static final class Immutable extends UserT2Match {
