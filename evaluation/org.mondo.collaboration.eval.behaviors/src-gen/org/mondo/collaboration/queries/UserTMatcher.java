...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.queries.userT pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link UserTMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see UserTMatch
 * @see UserTProcessor
 * @see UserTQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class UserTMatcher extends BaseMatcher<UserTMatch> {
  /**
   ...
   * 
   */
  public static UserTMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    UserTMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new UserTMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(UserTMatcher.class);
   ...
   */
  @Deprecated
  public UserTMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public UserTMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a UserTMatch object.
   * 
   */
  public Collection<UserTMatch> getAllMatches(final Control pCtrl, final Signal pSgn, final String pC, final String pT) {
   ...
   * @param pC the fixed value of pattern parameter c, or null if not bound.
   * @param pT the fixed value of pattern parameter t, or null if not bound.
   * @return a match represented as a UserTMatch object, or null if no match is found.
   * 
   */
  public UserTMatch getOneArbitraryMatch(final Control pCtrl, final Signal pSgn, final String pC, final String pT) {
   ...
   * 
   */
  public void forEachMatch(final Control pCtrl, final Signal pSgn, final String pC, final String pT, final IMatchProcessor<? super UserTMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Control pCtrl, final Signal pSgn, final String pC, final String pT, final IMatchProcessor<? super UserTMatch> processor) {
   ...
   * 
   */
  public UserTMatch newMatch(final Control pCtrl, final Signal pSgn, final String pC, final String pT) {
    return UserTMatch.newMatch(pCtrl, pSgn, pC, pT);
  }
   ...
   * 
   */
  public Set<Control> getAllValuesOfctrl(final UserTMatch partialMatch) {
   ...
   * 
   */
  public Set<Signal> getAllValuesOfsgn(final UserTMatch partialMatch) {
   ...
   * 
   */
  public Set<String> getAllValuesOfc(final UserTMatch partialMatch) {
   ...
   * 
   */
  public Set<String> getAllValuesOft(final UserTMatch partialMatch) {
  ...
  @Override
  protected UserTMatch tupleToMatch(final Tuple t) {
    try {
    	return UserTMatch.newMatch((wt.Control) t.get(POSITION_CTRL), (wt.Signal) t.get(POSITION_SGN), (java.lang.String) t.get(POSITION_C), (java.lang.String) t.get(POSITION_T));
  ...
  @Override
  protected UserTMatch arrayToMatch(final Object[] match) {
    try {
    	return UserTMatch.newMatch((wt.Control) match[POSITION_CTRL], (wt.Signal) match[POSITION_SGN], (java.lang.String) match[POSITION_C], (java.lang.String) match[POSITION_T]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected UserTMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return UserTMatch.newMutableMatch((wt.Control) match[POSITION_CTRL], (wt.Signal) match[POSITION_SGN], (java.lang.String) match[POSITION_C], (java.lang.String) match[POSITION_T]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<UserTMatcher> querySpecification() throws IncQueryException {
