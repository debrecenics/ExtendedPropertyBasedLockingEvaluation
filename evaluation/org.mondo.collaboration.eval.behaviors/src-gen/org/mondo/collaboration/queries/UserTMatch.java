...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.queries.userT pattern,
 * to be used in conjunction with {@link UserTMatcher}.
 * 
...
public abstract class UserTMatch extends BasePatternMatch {
  ...
  private UserTMatch(final Control pCtrl, final Signal pSgn, final String pC, final String pT) {
    this.fCtrl = pCtrl;
    this.fSgn = pSgn;
    this.fC = pC;
    this.fT = pT;
  ...
  public List<String> parameterNames() {
    return UserTMatch.parameterNames;
  }
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof UserTMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    UserTMatch other = (UserTMatch) obj;
  ...
  @Override
  public UserTQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static UserTMatch newEmptyMatch() {
   ...
   * 
   */
  public static UserTMatch newMutableMatch(final Control pCtrl, final Signal pSgn, final String pC, final String pT) {
   ...
   * 
   */
  public static UserTMatch newMatch(final Control pCtrl, final Signal pSgn, final String pC, final String pT) {
    return new Immutable(pCtrl, pSgn, pC, pT);
  }
  
  private static final class Mutable extends UserTMatch {
  ...
  private static final class Immutable extends UserTMatch {
