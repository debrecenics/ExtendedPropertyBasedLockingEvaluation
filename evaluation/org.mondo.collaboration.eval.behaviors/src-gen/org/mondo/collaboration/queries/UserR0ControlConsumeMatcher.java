...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.queries.userR0ControlConsume pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link UserR0ControlConsumeMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see UserR0ControlConsumeProcessor
 * @see UserR0ControlConsumeQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class UserR0ControlConsumeMatcher extends BaseMatcher<UserR0ControlConsumeMatch> {
  /**
   ...
   * 
   */
  public static UserR0ControlConsumeMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    UserR0ControlConsumeMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new UserR0ControlConsumeMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(UserR0ControlConsumeMatcher.class);
   ...
   */
  @Deprecated
  public UserR0ControlConsumeMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public UserR0ControlConsumeMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a UserR0ControlConsumeMatch object.
   * 
   */
  public Collection<UserR0ControlConsumeMatch> getAllMatches(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
   ...
   * @param pSignal the fixed value of pattern parameter signal, or null if not bound.
   * @param pComposite the fixed value of pattern parameter composite, or null if not bound.
   * @return a match represented as a UserR0ControlConsumeMatch object, or null if no match is found.
   * 
   */
  public UserR0ControlConsumeMatch getOneArbitraryMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
   ...
   * 
   */
  public void forEachMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite, final IMatchProcessor<? super UserR0ControlConsumeMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite, final IMatchProcessor<? super UserR0ControlConsumeMatch> processor) {
   ...
   * 
   */
  public UserR0ControlConsumeMatch newMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
    return UserR0ControlConsumeMatch.newMatch(pVendor, pObject, pSignal, pComposite);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfvendor(final UserR0ControlConsumeMatch partialMatch) {
   ...
   * 
   */
  public Set<Control> getAllValuesOfobject(final UserR0ControlConsumeMatch partialMatch) {
   ...
   * 
   */
  public Set<Signal> getAllValuesOfsignal(final UserR0ControlConsumeMatch partialMatch) {
   ...
   * 
   */
  public Set<Composite> getAllValuesOfcomposite(final UserR0ControlConsumeMatch partialMatch) {
  ...
  @Override
  protected UserR0ControlConsumeMatch tupleToMatch(final Tuple t) {
    try {
    	return UserR0ControlConsumeMatch.newMatch((java.lang.String) t.get(POSITION_VENDOR), (wt.Control) t.get(POSITION_OBJECT), (wt.Signal) t.get(POSITION_SIGNAL), (wt.Composite) t.get(POSITION_COMPOSITE));
  ...
  @Override
  protected UserR0ControlConsumeMatch arrayToMatch(final Object[] match) {
    try {
    	return UserR0ControlConsumeMatch.newMatch((java.lang.String) match[POSITION_VENDOR], (wt.Control) match[POSITION_OBJECT], (wt.Signal) match[POSITION_SIGNAL], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected UserR0ControlConsumeMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return UserR0ControlConsumeMatch.newMutableMatch((java.lang.String) match[POSITION_VENDOR], (wt.Control) match[POSITION_OBJECT], (wt.Signal) match[POSITION_SIGNAL], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<UserR0ControlConsumeMatcher> querySpecification() throws IncQueryException {
