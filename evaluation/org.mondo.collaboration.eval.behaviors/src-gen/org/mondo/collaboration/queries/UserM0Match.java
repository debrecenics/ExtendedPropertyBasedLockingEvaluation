...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.queries.userM0 pattern,
 * to be used in conjunction with {@link UserM0Matcher}.
 * 
...
public abstract class UserM0Match extends BasePatternMatch {
  ...
  private UserM0Match(final Control pCtrl, final Signal pSgn, final Integer pF) {
    this.fCtrl = pCtrl;
    this.fSgn = pSgn;
    this.fF = pF;
  }
  ...
  public List<String> parameterNames() {
    return UserM0Match.parameterNames;
  }
  ...
  @Override
  public UserM0Match toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof UserM0Match)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    UserM0Match other = (UserM0Match) obj;
  ...
  @Override
  public UserM0QuerySpecification specification() {
    try {
   ...
   * 
   */
  public static UserM0Match newEmptyMatch() {
   ...
   * 
   */
  public static UserM0Match newMutableMatch(final Control pCtrl, final Signal pSgn, final Integer pF) {
   ...
   * 
   */
  public static UserM0Match newMatch(final Control pCtrl, final Signal pSgn, final Integer pF) {
    return new Immutable(pCtrl, pSgn, pF);
  }
  
  private static final class Mutable extends UserM0Match {
  ...
  private static final class Immutable extends UserM0Match {
