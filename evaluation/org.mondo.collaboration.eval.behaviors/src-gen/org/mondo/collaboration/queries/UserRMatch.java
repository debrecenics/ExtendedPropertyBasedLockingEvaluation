...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.queries.userR pattern,
 * to be used in conjunction with {@link UserRMatcher}.
 * 
...
public abstract class UserRMatch extends BasePatternMatch {
  ...
  private UserRMatch(final String pVendor, final Object pObject, final Composite pComposite) {
  ...
  public List<String> parameterNames() {
    return UserRMatch.parameterNames;
  }
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof UserRMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    UserRMatch other = (UserRMatch) obj;
  ...
  @Override
  public UserRQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static UserRMatch newEmptyMatch() {
   ...
   * 
   */
  public static UserRMatch newMutableMatch(final String pVendor, final Object pObject, final Composite pComposite) {
   ...
   * 
   */
  public static UserRMatch newMatch(final String pVendor, final Object pObject, final Composite pComposite) {
    return new Immutable(pVendor, pObject, pComposite);
  }
  
  private static final class Mutable extends UserRMatch {
  ...
  private static final class Immutable extends UserRMatch {
