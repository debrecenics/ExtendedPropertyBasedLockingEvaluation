...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.queries.userRControlType pattern,
 * to be used in conjunction with {@link UserRControlTypeMatcher}.
 * 
...
public abstract class UserRControlTypeMatch extends BasePatternMatch {
  ...
  private UserRControlTypeMatch(final String pVendor, final Control pObject, final String pType, final Composite pComposite) {
  ...
  public List<String> parameterNames() {
    return UserRControlTypeMatch.parameterNames;
  }
  ...
  @Override
  public UserRControlTypeMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof UserRControlTypeMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    UserRControlTypeMatch other = (UserRControlTypeMatch) obj;
  ...
  @Override
  public UserRControlTypeQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static UserRControlTypeMatch newEmptyMatch() {
   ...
   * 
   */
  public static UserRControlTypeMatch newMutableMatch(final String pVendor, final Control pObject, final String pType, final Composite pComposite) {
   ...
   * 
   */
  public static UserRControlTypeMatch newMatch(final String pVendor, final Control pObject, final String pType, final Composite pComposite) {
    return new Immutable(pVendor, pObject, pType, pComposite);
  }
  
  private static final class Mutable extends UserRControlTypeMatch {
  ...
  private static final class Immutable extends UserRControlTypeMatch {
