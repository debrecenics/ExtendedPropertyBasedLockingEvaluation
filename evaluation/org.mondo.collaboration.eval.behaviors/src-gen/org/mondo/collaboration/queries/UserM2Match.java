...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.queries.userM2 pattern,
 * to be used in conjunction with {@link UserM2Matcher}.
 * 
...
public abstract class UserM2Match extends BasePatternMatch {
  ...
  private UserM2Match(final Control pCtrl, final Signal pSgn, final Integer pF) {
    this.fCtrl = pCtrl;
    this.fSgn = pSgn;
    this.fF = pF;
  }
  ...
  public List<String> parameterNames() {
    return UserM2Match.parameterNames;
  }
  ...
  @Override
  public UserM2Match toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof UserM2Match)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    UserM2Match other = (UserM2Match) obj;
  ...
  @Override
  public UserM2QuerySpecification specification() {
    try {
   ...
   * 
   */
  public static UserM2Match newMutableMatch(final Control pCtrl, final Signal pSgn, final Integer pF) {
   ...
   * 
   */
  public static UserM2Match newMatch(final Control pCtrl, final Signal pSgn, final Integer pF) {
    return new Immutable(pCtrl, pSgn, pF);
  }
  
  private static final class Mutable extends UserM2Match {
  ...
  private static final class Immutable extends UserM2Match {
