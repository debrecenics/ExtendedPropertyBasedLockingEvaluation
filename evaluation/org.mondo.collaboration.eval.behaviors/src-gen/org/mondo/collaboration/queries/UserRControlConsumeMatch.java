...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.queries.userRControlConsume pattern,
 * to be used in conjunction with {@link UserRControlConsumeMatcher}.
 * 
...
public abstract class UserRControlConsumeMatch extends BasePatternMatch {
  ...
  private UserRControlConsumeMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
  ...
  public List<String> parameterNames() {
    return UserRControlConsumeMatch.parameterNames;
  }
  ...
  @Override
  public UserRControlConsumeMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof UserRControlConsumeMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    UserRControlConsumeMatch other = (UserRControlConsumeMatch) obj;
  ...
  @Override
  public UserRControlConsumeQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static UserRControlConsumeMatch newEmptyMatch() {
   ...
   * 
   */
  public static UserRControlConsumeMatch newMutableMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
   ...
   * 
   */
  public static UserRControlConsumeMatch newMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
    return new Immutable(pVendor, pObject, pSignal, pComposite);
  }
  
  private static final class Mutable extends UserRControlConsumeMatch {
  ...
  private static final class Immutable extends UserRControlConsumeMatch {
