...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.queries.userR2SignalFrequency pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link UserR2SignalFrequencyMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * </pre></code>
 * 
 * @see UserR2SignalFrequencyMatch
 * @see UserR2SignalFrequencyProcessor
 * @see UserR2SignalFrequencyQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class UserR2SignalFrequencyMatcher extends BaseMatcher<UserR2SignalFrequencyMatch> {
  /**
   ...
   * 
   */
  public static UserR2SignalFrequencyMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    UserR2SignalFrequencyMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new UserR2SignalFrequencyMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(UserR2SignalFrequencyMatcher.class);
   ...
   */
  @Deprecated
  public UserR2SignalFrequencyMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public UserR2SignalFrequencyMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a UserR2SignalFrequencyMatch object.
   * 
   */
  public Collection<UserR2SignalFrequencyMatch> getAllMatches(final String pVendor, final Signal pObject, final Integer pFrequency, final Composite pComposite) {
   ...
   * @param pFrequency the fixed value of pattern parameter frequency, or null if not bound.
   * @param pComposite the fixed value of pattern parameter composite, or null if not bound.
   * @return a match represented as a UserR2SignalFrequencyMatch object, or null if no match is found.
   * 
   */
  public UserR2SignalFrequencyMatch getOneArbitraryMatch(final String pVendor, final Signal pObject, final Integer pFrequency, final Composite pComposite) {
   ...
   * 
   */
  public void forEachMatch(final String pVendor, final Signal pObject, final Integer pFrequency, final Composite pComposite, final IMatchProcessor<? super UserR2SignalFrequencyMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pVendor, final Signal pObject, final Integer pFrequency, final Composite pComposite, final IMatchProcessor<? super UserR2SignalFrequencyMatch> processor) {
   ...
   * 
   */
  public UserR2SignalFrequencyMatch newMatch(final String pVendor, final Signal pObject, final Integer pFrequency, final Composite pComposite) {
    return UserR2SignalFrequencyMatch.newMatch(pVendor, pObject, pFrequency, pComposite);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfvendor(final UserR2SignalFrequencyMatch partialMatch) {
   ...
   * 
   */
  public Set<Signal> getAllValuesOfobject(final UserR2SignalFrequencyMatch partialMatch) {
   ...
   * 
   */
  public Set<Integer> getAllValuesOffrequency(final UserR2SignalFrequencyMatch partialMatch) {
   ...
   * 
   */
  public Set<Composite> getAllValuesOfcomposite(final UserR2SignalFrequencyMatch partialMatch) {
  ...
  @Override
  protected UserR2SignalFrequencyMatch tupleToMatch(final Tuple t) {
    try {
    	return UserR2SignalFrequencyMatch.newMatch((java.lang.String) t.get(POSITION_VENDOR), (wt.Signal) t.get(POSITION_OBJECT), (java.lang.Integer) t.get(POSITION_FREQUENCY), (wt.Composite) t.get(POSITION_COMPOSITE));
  ...
  @Override
  protected UserR2SignalFrequencyMatch arrayToMatch(final Object[] match) {
    try {
    	return UserR2SignalFrequencyMatch.newMatch((java.lang.String) match[POSITION_VENDOR], (wt.Signal) match[POSITION_OBJECT], (java.lang.Integer) match[POSITION_FREQUENCY], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected UserR2SignalFrequencyMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return UserR2SignalFrequencyMatch.newMutableMatch((java.lang.String) match[POSITION_VENDOR], (wt.Signal) match[POSITION_OBJECT], (java.lang.Integer) match[POSITION_FREQUENCY], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<UserR2SignalFrequencyMatcher> querySpecification() throws IncQueryException {
