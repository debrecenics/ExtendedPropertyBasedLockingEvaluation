...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.queries.userRControlType pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link UserRControlTypeMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see UserRControlTypeProcessor
 * @see UserRControlTypeQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class UserRControlTypeMatcher extends BaseMatcher<UserRControlTypeMatch> {
  /**
   ...
   * 
   */
  public static UserRControlTypeMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    UserRControlTypeMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new UserRControlTypeMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(UserRControlTypeMatcher.class);
   ...
   */
  @Deprecated
  public UserRControlTypeMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public UserRControlTypeMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a UserRControlTypeMatch object.
   * 
   */
  public Collection<UserRControlTypeMatch> getAllMatches(final String pVendor, final Control pObject, final String pType, final Composite pComposite) {
   ...
   * @param pType the fixed value of pattern parameter type, or null if not bound.
   * @param pComposite the fixed value of pattern parameter composite, or null if not bound.
   * @return a match represented as a UserRControlTypeMatch object, or null if no match is found.
   * 
   */
  public UserRControlTypeMatch getOneArbitraryMatch(final String pVendor, final Control pObject, final String pType, final Composite pComposite) {
   ...
   * 
   */
  public void forEachMatch(final String pVendor, final Control pObject, final String pType, final Composite pComposite, final IMatchProcessor<? super UserRControlTypeMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pVendor, final Control pObject, final String pType, final Composite pComposite, final IMatchProcessor<? super UserRControlTypeMatch> processor) {
   ...
   * 
   */
  public UserRControlTypeMatch newMatch(final String pVendor, final Control pObject, final String pType, final Composite pComposite) {
    return UserRControlTypeMatch.newMatch(pVendor, pObject, pType, pComposite);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfvendor(final UserRControlTypeMatch partialMatch) {
   ...
   * 
   */
  public Set<Control> getAllValuesOfobject(final UserRControlTypeMatch partialMatch) {
   ...
   * 
   */
  public Set<String> getAllValuesOftype(final UserRControlTypeMatch partialMatch) {
   ...
   * 
   */
  public Set<Composite> getAllValuesOfcomposite(final UserRControlTypeMatch partialMatch) {
  ...
  @Override
  protected UserRControlTypeMatch tupleToMatch(final Tuple t) {
    try {
    	return UserRControlTypeMatch.newMatch((java.lang.String) t.get(POSITION_VENDOR), (wt.Control) t.get(POSITION_OBJECT), (java.lang.String) t.get(POSITION_TYPE), (wt.Composite) t.get(POSITION_COMPOSITE));
  ...
  @Override
  protected UserRControlTypeMatch arrayToMatch(final Object[] match) {
    try {
    	return UserRControlTypeMatch.newMatch((java.lang.String) match[POSITION_VENDOR], (wt.Control) match[POSITION_OBJECT], (java.lang.String) match[POSITION_TYPE], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected UserRControlTypeMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return UserRControlTypeMatch.newMutableMatch((java.lang.String) match[POSITION_VENDOR], (wt.Control) match[POSITION_OBJECT], (java.lang.String) match[POSITION_TYPE], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<UserRControlTypeMatcher> querySpecification() throws IncQueryException {
