...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.queries.userRSignalFrequency pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link UserRSignalFrequencyMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see UserRSignalFrequencyProcessor
 * @see UserRSignalFrequencyQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class UserRSignalFrequencyMatcher extends BaseMatcher<UserRSignalFrequencyMatch> {
  /**
   ...
   * 
   */
  public static UserRSignalFrequencyMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    UserRSignalFrequencyMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new UserRSignalFrequencyMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(UserRSignalFrequencyMatcher.class);
   ...
   */
  @Deprecated
  public UserRSignalFrequencyMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public UserRSignalFrequencyMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a UserRSignalFrequencyMatch object.
   * 
   */
  public Collection<UserRSignalFrequencyMatch> getAllMatches(final String pVendor, final Signal pObject, final Integer pFrequency, final Composite pComposite) {
   ...
   * @param pFrequency the fixed value of pattern parameter frequency, or null if not bound.
   * @param pComposite the fixed value of pattern parameter composite, or null if not bound.
   * @return a match represented as a UserRSignalFrequencyMatch object, or null if no match is found.
   * 
   */
  public UserRSignalFrequencyMatch getOneArbitraryMatch(final String pVendor, final Signal pObject, final Integer pFrequency, final Composite pComposite) {
   ...
   * 
   */
  public void forEachMatch(final String pVendor, final Signal pObject, final Integer pFrequency, final Composite pComposite, final IMatchProcessor<? super UserRSignalFrequencyMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pVendor, final Signal pObject, final Integer pFrequency, final Composite pComposite, final IMatchProcessor<? super UserRSignalFrequencyMatch> processor) {
   ...
   * 
   */
  public UserRSignalFrequencyMatch newMatch(final String pVendor, final Signal pObject, final Integer pFrequency, final Composite pComposite) {
    return UserRSignalFrequencyMatch.newMatch(pVendor, pObject, pFrequency, pComposite);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfvendor(final UserRSignalFrequencyMatch partialMatch) {
   ...
   * 
   */
  public Set<Signal> getAllValuesOfobject(final UserRSignalFrequencyMatch partialMatch) {
   ...
   * 
   */
  public Set<Integer> getAllValuesOffrequency(final UserRSignalFrequencyMatch partialMatch) {
   ...
   * 
   */
  public Set<Composite> getAllValuesOfcomposite(final UserRSignalFrequencyMatch partialMatch) {
  ...
  @Override
  protected UserRSignalFrequencyMatch tupleToMatch(final Tuple t) {
    try {
    	return UserRSignalFrequencyMatch.newMatch((java.lang.String) t.get(POSITION_VENDOR), (wt.Signal) t.get(POSITION_OBJECT), (java.lang.Integer) t.get(POSITION_FREQUENCY), (wt.Composite) t.get(POSITION_COMPOSITE));
  ...
  @Override
  protected UserRSignalFrequencyMatch arrayToMatch(final Object[] match) {
    try {
    	return UserRSignalFrequencyMatch.newMatch((java.lang.String) match[POSITION_VENDOR], (wt.Signal) match[POSITION_OBJECT], (java.lang.Integer) match[POSITION_FREQUENCY], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected UserRSignalFrequencyMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return UserRSignalFrequencyMatch.newMutableMatch((java.lang.String) match[POSITION_VENDOR], (wt.Signal) match[POSITION_OBJECT], (java.lang.Integer) match[POSITION_FREQUENCY], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<UserRSignalFrequencyMatcher> querySpecification() throws IncQueryException {
