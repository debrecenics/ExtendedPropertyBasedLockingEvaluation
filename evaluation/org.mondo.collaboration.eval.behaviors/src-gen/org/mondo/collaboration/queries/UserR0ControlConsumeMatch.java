...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.queries.userR0ControlConsume pattern,
 * to be used in conjunction with {@link UserR0ControlConsumeMatcher}.
 * 
...
public abstract class UserR0ControlConsumeMatch extends BasePatternMatch {
  ...
  private UserR0ControlConsumeMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
  ...
  public List<String> parameterNames() {
    return UserR0ControlConsumeMatch.parameterNames;
  }
  ...
  @Override
  public UserR0ControlConsumeMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof UserR0ControlConsumeMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    UserR0ControlConsumeMatch other = (UserR0ControlConsumeMatch) obj;
  ...
  @Override
  public UserR0ControlConsumeQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static UserR0ControlConsumeMatch newEmptyMatch() {
   ...
   * 
   */
  public static UserR0ControlConsumeMatch newMutableMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
   ...
   * 
   */
  public static UserR0ControlConsumeMatch newMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
    return new Immutable(pVendor, pObject, pSignal, pComposite);
  }
  
  private static final class Mutable extends UserR0ControlConsumeMatch {
  ...
  private static final class Immutable extends UserR0ControlConsumeMatch {
