...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.queries.userR1SignalFrequency pattern,
 * to be used in conjunction with {@link UserR1SignalFrequencyMatcher}.
 * 
...
public abstract class UserR1SignalFrequencyMatch extends BasePatternMatch {
  ...
  private UserR1SignalFrequencyMatch(final String pVendor, final Signal pObject, final Integer pFrequency, final Composite pComposite) {
  ...
  public List<String> parameterNames() {
    return UserR1SignalFrequencyMatch.parameterNames;
  }
  ...
  @Override
  public UserR1SignalFrequencyMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof UserR1SignalFrequencyMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    UserR1SignalFrequencyMatch other = (UserR1SignalFrequencyMatch) obj;
  ...
  @Override
  public UserR1SignalFrequencyQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static UserR1SignalFrequencyMatch newEmptyMatch() {
   ...
   * 
   */
  public static UserR1SignalFrequencyMatch newMutableMatch(final String pVendor, final Signal pObject, final Integer pFrequency, final Composite pComposite) {
   ...
   * 
   */
  public static UserR1SignalFrequencyMatch newMatch(final String pVendor, final Signal pObject, final Integer pFrequency, final Composite pComposite) {
    return new Immutable(pVendor, pObject, pFrequency, pComposite);
  }
  
  private static final class Mutable extends UserR1SignalFrequencyMatch {
  ...
  private static final class Immutable extends UserR1SignalFrequencyMatch {
