...
/**
 * A match processor tailored for the org.mondo.collaboration.queries.userT pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class UserTProcessor implements IMatchProcessor<UserTMatch> {
  /**
  ...
  @Override
  public void process(final UserTMatch match) {
