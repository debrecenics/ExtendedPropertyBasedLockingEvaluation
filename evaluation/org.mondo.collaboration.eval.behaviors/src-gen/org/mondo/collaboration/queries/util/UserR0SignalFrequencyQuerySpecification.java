...
/**
 * A pattern-specific query specification that can instantiate UserR0SignalFrequencyMatcher in a type-safe way.
 * 
...
public final class UserR0SignalFrequencyQuerySpecification extends BaseGeneratedEMFQuerySpecification<UserR0SignalFrequencyMatcher> {
  private UserR0SignalFrequencyQuerySpecification() {
   ...
   * 
   */
  public static UserR0SignalFrequencyQuerySpecification instance() throws IncQueryException {
    try{
  ...
  @Override
  protected UserR0SignalFrequencyMatcher instantiate(final IncQueryEngine engine) throws IncQueryException {
    return UserR0SignalFrequencyMatcher.on(engine);
  }
  
  @Override
  public UserR0SignalFrequencyMatch newEmptyMatch() {
    return UserR0SignalFrequencyMatch.newEmptyMatch();
  }
  
  @Override
  public UserR0SignalFrequencyMatch newMatch(final Object... parameters) {
    return UserR0SignalFrequencyMatch.newMatch((java.lang.String) parameters[0], (wt.Signal) parameters[1], (java.lang.Integer) parameters[2], (wt.Composite) parameters[3]);
  }
  
  private static class LazyHolder {
    private final static UserR0SignalFrequencyQuerySpecification INSTANCE = make();
    
    public static UserR0SignalFrequencyQuerySpecification make() {
      return new UserR0SignalFrequencyQuerySpecification();					
    }
  }
  
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static UserR0SignalFrequencyQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
