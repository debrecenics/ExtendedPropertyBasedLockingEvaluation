...
/**
 * A pattern-specific query specification that can instantiate UserT0Matcher in a type-safe way.
 * 
 * @see UserT0Matcher
 * @see UserT0Match
 * 
...
public final class UserT0QuerySpecification extends BaseGeneratedEMFQuerySpecification<UserT0Matcher> {
  private UserT0QuerySpecification() {
   ...
   * 
   */
  public static UserT0QuerySpecification instance() throws IncQueryException {
    try{
  ...
  @Override
  protected UserT0Matcher instantiate(final IncQueryEngine engine) throws IncQueryException {
    return UserT0Matcher.on(engine);
  }
  
  @Override
  public UserT0Match newEmptyMatch() {
    return UserT0Match.newEmptyMatch();
  }
  
  @Override
  public UserT0Match newMatch(final Object... parameters) {
    return UserT0Match.newMatch((wt.Control) parameters[0], (wt.Signal) parameters[1], (java.lang.String) parameters[2], (java.lang.String) parameters[3]);
  }
  
  private static class LazyHolder {
    private final static UserT0QuerySpecification INSTANCE = make();
    
    public static UserT0QuerySpecification make() {
      return new UserT0QuerySpecification();					
    }
  }
  
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static UserT0QuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    @Override
    public String getFullyQualifiedName() {
      return "org.mondo.collaboration.queries.userT0";
    }
