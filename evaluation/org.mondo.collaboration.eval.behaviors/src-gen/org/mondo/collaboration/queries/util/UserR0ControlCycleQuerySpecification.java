...
/**
 * A pattern-specific query specification that can instantiate UserR0ControlCycleMatcher in a type-safe way.
 * 
...
public final class UserR0ControlCycleQuerySpecification extends BaseGeneratedEMFQuerySpecification<UserR0ControlCycleMatcher> {
  private UserR0ControlCycleQuerySpecification() {
   ...
   * 
   */
  public static UserR0ControlCycleQuerySpecification instance() throws IncQueryException {
    try{
  ...
  @Override
  protected UserR0ControlCycleMatcher instantiate(final IncQueryEngine engine) throws IncQueryException {
    return UserR0ControlCycleMatcher.on(engine);
  }
  
  @Override
  public UserR0ControlCycleMatch newEmptyMatch() {
    return UserR0ControlCycleMatch.newEmptyMatch();
  }
  
  @Override
  public UserR0ControlCycleMatch newMatch(final Object... parameters) {
    return UserR0ControlCycleMatch.newMatch((java.lang.String) parameters[0], (wt.Control) parameters[1], (java.lang.String) parameters[2], (wt.Composite) parameters[3]);
  }
  
  private static class LazyHolder {
    private final static UserR0ControlCycleQuerySpecification INSTANCE = make();
    
    public static UserR0ControlCycleQuerySpecification make() {
      return new UserR0ControlCycleQuerySpecification();					
    }
  }
  
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static UserR0ControlCycleQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
