...
/**
 * A pattern-specific query specification that can instantiate UserT1Matcher in a type-safe way.
 * 
 * @see UserT1Matcher
 * @see UserT1Match
 * 
...
public final class UserT1QuerySpecification extends BaseGeneratedEMFQuerySpecification<UserT1Matcher> {
  private UserT1QuerySpecification() {
   ...
   * 
   */
  public static UserT1QuerySpecification instance() throws IncQueryException {
    try{
  ...
  @Override
  protected UserT1Matcher instantiate(final IncQueryEngine engine) throws IncQueryException {
    return UserT1Matcher.on(engine);
  }
  
  @Override
  public UserT1Match newEmptyMatch() {
    return UserT1Match.newEmptyMatch();
  }
  
  @Override
  public UserT1Match newMatch(final Object... parameters) {
    return UserT1Match.newMatch((wt.Control) parameters[0], (wt.Signal) parameters[1], (java.lang.String) parameters[2], (java.lang.String) parameters[3]);
  }
  
  private static class LazyHolder {
    private final static UserT1QuerySpecification INSTANCE = make();
    
    public static UserT1QuerySpecification make() {
      return new UserT1QuerySpecification();					
    }
  }
  
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static UserT1QuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
