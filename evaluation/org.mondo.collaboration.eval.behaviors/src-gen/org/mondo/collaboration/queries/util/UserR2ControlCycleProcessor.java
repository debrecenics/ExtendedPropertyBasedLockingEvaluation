...
/**
 * A match processor tailored for the org.mondo.collaboration.queries.userR2ControlCycle pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class UserR2ControlCycleProcessor implements IMatchProcessor<UserR2ControlCycleMatch> {
  /**
  ...
  @Override
  public void process(final UserR2ControlCycleMatch match) {
