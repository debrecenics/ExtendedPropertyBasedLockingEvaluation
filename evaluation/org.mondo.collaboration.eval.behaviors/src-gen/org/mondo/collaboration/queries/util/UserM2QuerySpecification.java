...
/**
 * A pattern-specific query specification that can instantiate UserM2Matcher in a type-safe way.
 * 
 * @see UserM2Matcher
 * @see UserM2Match
 * 
...
public final class UserM2QuerySpecification extends BaseGeneratedEMFQuerySpecification<UserM2Matcher> {
  private UserM2QuerySpecification() {
   ...
   * 
   */
  public static UserM2QuerySpecification instance() throws IncQueryException {
    try{
  ...
  @Override
  protected UserM2Matcher instantiate(final IncQueryEngine engine) throws IncQueryException {
    return UserM2Matcher.on(engine);
  }
  
  @Override
  public UserM2Match newEmptyMatch() {
    return UserM2Match.newEmptyMatch();
  }
  
  @Override
  public UserM2Match newMatch(final Object... parameters) {
    return UserM2Match.newMatch((wt.Control) parameters[0], (wt.Signal) parameters[1], (java.lang.Integer) parameters[2]);
  }
  
  private static class LazyHolder {
    private final static UserM2QuerySpecification INSTANCE = make();
    
    public static UserM2QuerySpecification make() {
      return new UserM2QuerySpecification();					
    }
  }
  
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static UserM2QuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    @Override
    public String getFullyQualifiedName() {
      return "org.mondo.collaboration.queries.userM2";
    }
