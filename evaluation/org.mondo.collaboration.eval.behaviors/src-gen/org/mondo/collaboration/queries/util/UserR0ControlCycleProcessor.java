...
/**
 * A match processor tailored for the org.mondo.collaboration.queries.userR0ControlCycle pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class UserR0ControlCycleProcessor implements IMatchProcessor<UserR0ControlCycleMatch> {
  /**
  ...
  @Override
  public void process(final UserR0ControlCycleMatch match) {
