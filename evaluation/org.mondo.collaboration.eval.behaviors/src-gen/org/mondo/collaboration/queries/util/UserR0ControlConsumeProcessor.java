...
/**
 * A match processor tailored for the org.mondo.collaboration.queries.userR0ControlConsume pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class UserR0ControlConsumeProcessor implements IMatchProcessor<UserR0ControlConsumeMatch> {
  /**
  ...
  @Override
  public void process(final UserR0ControlConsumeMatch match) {
