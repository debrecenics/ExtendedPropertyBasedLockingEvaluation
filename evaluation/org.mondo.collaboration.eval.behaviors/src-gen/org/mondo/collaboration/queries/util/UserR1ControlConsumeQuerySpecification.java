...
/**
 * A pattern-specific query specification that can instantiate UserR1ControlConsumeMatcher in a type-safe way.
 * 
...
public final class UserR1ControlConsumeQuerySpecification extends BaseGeneratedEMFQuerySpecification<UserR1ControlConsumeMatcher> {
  private UserR1ControlConsumeQuerySpecification() {
   ...
   * 
   */
  public static UserR1ControlConsumeQuerySpecification instance() throws IncQueryException {
    try{
  ...
  @Override
  protected UserR1ControlConsumeMatcher instantiate(final IncQueryEngine engine) throws IncQueryException {
    return UserR1ControlConsumeMatcher.on(engine);
  }
  
  @Override
  public UserR1ControlConsumeMatch newEmptyMatch() {
    return UserR1ControlConsumeMatch.newEmptyMatch();
  }
  
  @Override
  public UserR1ControlConsumeMatch newMatch(final Object... parameters) {
    return UserR1ControlConsumeMatch.newMatch((java.lang.String) parameters[0], (wt.Control) parameters[1], (wt.Signal) parameters[2], (wt.Composite) parameters[3]);
  }
  
  private static class LazyHolder {
    private final static UserR1ControlConsumeQuerySpecification INSTANCE = make();
    
    public static UserR1ControlConsumeQuerySpecification make() {
      return new UserR1ControlConsumeQuerySpecification();					
    }
  }
  
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static UserR1ControlConsumeQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
