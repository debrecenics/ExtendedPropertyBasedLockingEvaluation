...
/**
 * A pattern-specific query specification that can instantiate UserR1ControlCycleMatcher in a type-safe way.
 * 
...
public final class UserR1ControlCycleQuerySpecification extends BaseGeneratedEMFQuerySpecification<UserR1ControlCycleMatcher> {
  private UserR1ControlCycleQuerySpecification() {
   ...
   * 
   */
  public static UserR1ControlCycleQuerySpecification instance() throws IncQueryException {
    try{
  ...
  @Override
  protected UserR1ControlCycleMatcher instantiate(final IncQueryEngine engine) throws IncQueryException {
    return UserR1ControlCycleMatcher.on(engine);
  }
  
  @Override
  public UserR1ControlCycleMatch newEmptyMatch() {
    return UserR1ControlCycleMatch.newEmptyMatch();
  }
  
  @Override
  public UserR1ControlCycleMatch newMatch(final Object... parameters) {
    return UserR1ControlCycleMatch.newMatch((java.lang.String) parameters[0], (wt.Control) parameters[1], (java.lang.String) parameters[2], (wt.Composite) parameters[3]);
  }
  
  private static class LazyHolder {
    private final static UserR1ControlCycleQuerySpecification INSTANCE = make();
    
    public static UserR1ControlCycleQuerySpecification make() {
      return new UserR1ControlCycleQuerySpecification();					
    }
  }
  
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static UserR1ControlCycleQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
