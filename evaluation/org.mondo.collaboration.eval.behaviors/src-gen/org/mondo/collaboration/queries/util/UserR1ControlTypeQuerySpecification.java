...
/**
 * A pattern-specific query specification that can instantiate UserR1ControlTypeMatcher in a type-safe way.
 * 
 * @see UserR1ControlTypeMatcher
 * @see UserR1ControlTypeMatch
 * 
 */
@SuppressWarnings("all")
public final class UserR1ControlTypeQuerySpecification extends BaseGeneratedEMFQuerySpecification<UserR1ControlTypeMatcher> {
  private UserR1ControlTypeQuerySpecification() {
   ...
   * 
   */
  public static UserR1ControlTypeQuerySpecification instance() throws IncQueryException {
    try{
  ...
  @Override
  protected UserR1ControlTypeMatcher instantiate(final IncQueryEngine engine) throws IncQueryException {
    return UserR1ControlTypeMatcher.on(engine);
  }
  
  @Override
  public UserR1ControlTypeMatch newEmptyMatch() {
    return UserR1ControlTypeMatch.newEmptyMatch();
  }
  
  @Override
  public UserR1ControlTypeMatch newMatch(final Object... parameters) {
    return UserR1ControlTypeMatch.newMatch((java.lang.String) parameters[0], (wt.Control) parameters[1], (java.lang.String) parameters[2], (wt.Composite) parameters[3]);
  }
  
  private static class LazyHolder {
    private final static UserR1ControlTypeQuerySpecification INSTANCE = make();
    
    public static UserR1ControlTypeQuerySpecification make() {
      return new UserR1ControlTypeQuerySpecification();					
    }
  }
  
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static UserR1ControlTypeQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    @Override
    public String getFullyQualifiedName() {
      return "org.mondo.collaboration.queries.userR1ControlType";
    }
    ...
    public Set<PBody> doGetContainedBodies() throws QueryInitializationException {
      ...
      try {
      {
      	...
      	new TypeConstraint(body, new FlatTuple(var_object), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://wt/access-control", "Control")));
      	new TypeConstraint(body, new FlatTuple(var_object, var__virtual_3_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://wt/access-control", "Control", "type")));
      	new Equality(body, var__virtual_3_, var_type);
      	bodies.add(body);
      }
