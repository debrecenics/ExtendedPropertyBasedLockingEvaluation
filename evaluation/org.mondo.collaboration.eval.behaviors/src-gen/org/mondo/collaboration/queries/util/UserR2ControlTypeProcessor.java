...
/**
 * A match processor tailored for the org.mondo.collaboration.queries.userR2ControlType pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class UserR2ControlTypeProcessor implements IMatchProcessor<UserR2ControlTypeMatch> {
  /**
  ...
  @Override
  public void process(final UserR2ControlTypeMatch match) {
