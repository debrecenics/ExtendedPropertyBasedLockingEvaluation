...
/**
 * A match processor tailored for the org.mondo.collaboration.queries.userR2ControlConsume pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class UserR2ControlConsumeProcessor implements IMatchProcessor<UserR2ControlConsumeMatch> {
  /**
  ...
  @Override
  public void process(final UserR2ControlConsumeMatch match) {
