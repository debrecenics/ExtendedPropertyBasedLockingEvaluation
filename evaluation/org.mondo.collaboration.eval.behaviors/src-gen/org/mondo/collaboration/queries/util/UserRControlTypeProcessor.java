...
/**
 * A match processor tailored for the org.mondo.collaboration.queries.userRControlType pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class UserRControlTypeProcessor implements IMatchProcessor<UserRControlTypeMatch> {
  /**
  ...
  @Override
  public void process(final UserRControlTypeMatch match) {
