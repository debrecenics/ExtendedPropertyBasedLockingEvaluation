...
/**
 * A match processor tailored for the org.mondo.collaboration.queries.userR pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class UserRProcessor implements IMatchProcessor<UserRMatch> {
  /**
  ...
  @Override
  public void process(final UserRMatch match) {
