...
/**
 * A pattern-specific query specification that can instantiate UserR2ControlConsumeMatcher in a type-safe way.
 * 
...
public final class UserR2ControlConsumeQuerySpecification extends BaseGeneratedEMFQuerySpecification<UserR2ControlConsumeMatcher> {
  private UserR2ControlConsumeQuerySpecification() {
   ...
   * 
   */
  public static UserR2ControlConsumeQuerySpecification instance() throws IncQueryException {
    try{
  ...
  @Override
  protected UserR2ControlConsumeMatcher instantiate(final IncQueryEngine engine) throws IncQueryException {
    return UserR2ControlConsumeMatcher.on(engine);
  }
  
  @Override
  public UserR2ControlConsumeMatch newEmptyMatch() {
    return UserR2ControlConsumeMatch.newEmptyMatch();
  }
  
  @Override
  public UserR2ControlConsumeMatch newMatch(final Object... parameters) {
    return UserR2ControlConsumeMatch.newMatch((java.lang.String) parameters[0], (wt.Control) parameters[1], (wt.Signal) parameters[2], (wt.Composite) parameters[3]);
  }
  
  private static class LazyHolder {
    private final static UserR2ControlConsumeQuerySpecification INSTANCE = make();
    
    public static UserR2ControlConsumeQuerySpecification make() {
      return new UserR2ControlConsumeQuerySpecification();					
    }
  }
  
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static UserR2ControlConsumeQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
