...
/**
 * A pattern-specific query specification that can instantiate UserR0ControlTypeMatcher in a type-safe way.
 * 
 * @see UserR0ControlTypeMatcher
 * @see UserR0ControlTypeMatch
 * 
 */
@SuppressWarnings("all")
public final class UserR0ControlTypeQuerySpecification extends BaseGeneratedEMFQuerySpecification<UserR0ControlTypeMatcher> {
  private UserR0ControlTypeQuerySpecification() {
   ...
   * 
   */
  public static UserR0ControlTypeQuerySpecification instance() throws IncQueryException {
    try{
  ...
  @Override
  protected UserR0ControlTypeMatcher instantiate(final IncQueryEngine engine) throws IncQueryException {
    return UserR0ControlTypeMatcher.on(engine);
  }
  
  @Override
  public UserR0ControlTypeMatch newEmptyMatch() {
    return UserR0ControlTypeMatch.newEmptyMatch();
  }
  
  @Override
  public UserR0ControlTypeMatch newMatch(final Object... parameters) {
    return UserR0ControlTypeMatch.newMatch((java.lang.String) parameters[0], (wt.Control) parameters[1], (java.lang.String) parameters[2], (wt.Composite) parameters[3]);
  }
  
  private static class LazyHolder {
    private final static UserR0ControlTypeQuerySpecification INSTANCE = make();
    
    public static UserR0ControlTypeQuerySpecification make() {
      return new UserR0ControlTypeQuerySpecification();					
    }
  }
  
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static UserR0ControlTypeQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    @Override
    public String getFullyQualifiedName() {
      return "org.mondo.collaboration.queries.userR0ControlType";
    }
