...
/**
 * A match processor tailored for the org.mondo.collaboration.queries.userR1ControlType pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class UserR1ControlTypeProcessor implements IMatchProcessor<UserR1ControlTypeMatch> {
  /**
  ...
  @Override
  public void process(final UserR1ControlTypeMatch match) {
