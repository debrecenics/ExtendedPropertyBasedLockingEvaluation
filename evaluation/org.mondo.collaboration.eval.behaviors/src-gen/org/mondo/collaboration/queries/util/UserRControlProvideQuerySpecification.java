...
/**
 * A pattern-specific query specification that can instantiate UserRControlProvideMatcher in a type-safe way.
 * 
...
public final class UserRControlProvideQuerySpecification extends BaseGeneratedEMFQuerySpecification<UserRControlProvideMatcher> {
  private UserRControlProvideQuerySpecification() {
   ...
   * 
   */
  public static UserRControlProvideQuerySpecification instance() throws IncQueryException {
    try{
  ...
  @Override
  protected UserRControlProvideMatcher instantiate(final IncQueryEngine engine) throws IncQueryException {
    return UserRControlProvideMatcher.on(engine);
  }
  
  @Override
  public UserRControlProvideMatch newEmptyMatch() {
    return UserRControlProvideMatch.newEmptyMatch();
  }
  
  @Override
  public UserRControlProvideMatch newMatch(final Object... parameters) {
    return UserRControlProvideMatch.newMatch((java.lang.String) parameters[0], (wt.Control) parameters[1], (wt.Signal) parameters[2], (wt.Composite) parameters[3]);
  }
  
  private static class LazyHolder {
    private final static UserRControlProvideQuerySpecification INSTANCE = make();
    
    public static UserRControlProvideQuerySpecification make() {
      return new UserRControlProvideQuerySpecification();					
    }
  }
  
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static UserRControlProvideQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
