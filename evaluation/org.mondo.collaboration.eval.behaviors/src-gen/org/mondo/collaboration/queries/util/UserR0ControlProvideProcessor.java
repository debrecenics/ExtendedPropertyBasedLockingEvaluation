...
/**
 * A match processor tailored for the org.mondo.collaboration.queries.userR0ControlProvide pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class UserR0ControlProvideProcessor implements IMatchProcessor<UserR0ControlProvideMatch> {
  /**
  ...
  @Override
  public void process(final UserR0ControlProvideMatch match) {
