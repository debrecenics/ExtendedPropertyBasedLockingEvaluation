...
/**
 * A pattern-specific query specification that can instantiate UserR2Matcher in a type-safe way.
 * 
 * @see UserR2Matcher
 * @see UserR2Match
 * 
...
public final class UserR2QuerySpecification extends BaseGeneratedEMFQuerySpecification<UserR2Matcher> {
  private UserR2QuerySpecification() {
   ...
   * 
   */
  public static UserR2QuerySpecification instance() throws IncQueryException {
    try{
  ...
  @Override
  protected UserR2Matcher instantiate(final IncQueryEngine engine) throws IncQueryException {
    return UserR2Matcher.on(engine);
  }
  
  @Override
  public UserR2Match newEmptyMatch() {
    return UserR2Match.newEmptyMatch();
  }
  
  @Override
  public UserR2Match newMatch(final Object... parameters) {
    return UserR2Match.newMatch((java.lang.String) parameters[0], (java.lang.Object) parameters[1], (wt.Composite) parameters[2]);
  }
  
  private static class LazyHolder {
    private final static UserR2QuerySpecification INSTANCE = make();
    
    public static UserR2QuerySpecification make() {
      return new UserR2QuerySpecification();					
    }
  }
  
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static UserR2QuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
