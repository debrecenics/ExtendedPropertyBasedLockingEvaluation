...
/**
 * A match processor tailored for the org.mondo.collaboration.queries.userR1ControlConsume pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class UserR1ControlConsumeProcessor implements IMatchProcessor<UserR1ControlConsumeMatch> {
  /**
  ...
  @Override
  public void process(final UserR1ControlConsumeMatch match) {
