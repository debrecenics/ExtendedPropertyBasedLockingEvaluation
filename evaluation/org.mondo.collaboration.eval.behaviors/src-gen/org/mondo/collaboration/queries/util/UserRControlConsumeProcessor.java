...
/**
 * A match processor tailored for the org.mondo.collaboration.queries.userRControlConsume pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class UserRControlConsumeProcessor implements IMatchProcessor<UserRControlConsumeMatch> {
  /**
  ...
  @Override
  public void process(final UserRControlConsumeMatch match) {
