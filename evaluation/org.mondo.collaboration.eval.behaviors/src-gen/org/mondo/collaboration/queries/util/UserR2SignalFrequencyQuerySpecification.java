...
/**
 * A pattern-specific query specification that can instantiate UserR2SignalFrequencyMatcher in a type-safe way.
 * 
...
public final class UserR2SignalFrequencyQuerySpecification extends BaseGeneratedEMFQuerySpecification<UserR2SignalFrequencyMatcher> {
  private UserR2SignalFrequencyQuerySpecification() {
   ...
   * 
   */
  public static UserR2SignalFrequencyQuerySpecification instance() throws IncQueryException {
    try{
  ...
  @Override
  protected UserR2SignalFrequencyMatcher instantiate(final IncQueryEngine engine) throws IncQueryException {
    return UserR2SignalFrequencyMatcher.on(engine);
  }
  
  @Override
  public UserR2SignalFrequencyMatch newEmptyMatch() {
    return UserR2SignalFrequencyMatch.newEmptyMatch();
  }
  
  @Override
  public UserR2SignalFrequencyMatch newMatch(final Object... parameters) {
    return UserR2SignalFrequencyMatch.newMatch((java.lang.String) parameters[0], (wt.Signal) parameters[1], (java.lang.Integer) parameters[2], (wt.Composite) parameters[3]);
  }
  
  private static class LazyHolder {
    private final static UserR2SignalFrequencyQuerySpecification INSTANCE = make();
    
    public static UserR2SignalFrequencyQuerySpecification make() {
      return new UserR2SignalFrequencyQuerySpecification();					
    }
  }
  
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static UserR2SignalFrequencyQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
