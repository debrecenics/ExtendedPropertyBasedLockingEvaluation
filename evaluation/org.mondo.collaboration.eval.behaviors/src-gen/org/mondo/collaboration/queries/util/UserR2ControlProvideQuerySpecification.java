...
/**
 * A pattern-specific query specification that can instantiate UserR2ControlProvideMatcher in a type-safe way.
 * 
...
public final class UserR2ControlProvideQuerySpecification extends BaseGeneratedEMFQuerySpecification<UserR2ControlProvideMatcher> {
  private UserR2ControlProvideQuerySpecification() {
   ...
   * 
   */
  public static UserR2ControlProvideQuerySpecification instance() throws IncQueryException {
    try{
  ...
  @Override
  protected UserR2ControlProvideMatcher instantiate(final IncQueryEngine engine) throws IncQueryException {
    return UserR2ControlProvideMatcher.on(engine);
  }
  
  @Override
  public UserR2ControlProvideMatch newEmptyMatch() {
    return UserR2ControlProvideMatch.newEmptyMatch();
  }
  
  @Override
  public UserR2ControlProvideMatch newMatch(final Object... parameters) {
    return UserR2ControlProvideMatch.newMatch((java.lang.String) parameters[0], (wt.Control) parameters[1], (wt.Signal) parameters[2], (wt.Composite) parameters[3]);
  }
  
  private static class LazyHolder {
    private final static UserR2ControlProvideQuerySpecification INSTANCE = make();
    
    public static UserR2ControlProvideQuerySpecification make() {
      return new UserR2ControlProvideQuerySpecification();					
    }
  }
  
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static UserR2ControlProvideQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
