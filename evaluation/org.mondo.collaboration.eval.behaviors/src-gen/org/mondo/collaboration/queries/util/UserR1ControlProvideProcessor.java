...
/**
 * A match processor tailored for the org.mondo.collaboration.queries.userR1ControlProvide pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class UserR1ControlProvideProcessor implements IMatchProcessor<UserR1ControlProvideMatch> {
  /**
  ...
  @Override
  public void process(final UserR1ControlProvideMatch match) {
