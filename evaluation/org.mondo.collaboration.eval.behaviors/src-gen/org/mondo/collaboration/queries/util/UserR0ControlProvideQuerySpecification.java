...
/**
 * A pattern-specific query specification that can instantiate UserR0ControlProvideMatcher in a type-safe way.
 * 
 * @see UserR0ControlProvideMatcher
 * @see UserR0ControlProvideMatch
 * 
 */
@SuppressWarnings("all")
public final class UserR0ControlProvideQuerySpecification extends BaseGeneratedEMFQuerySpecification<UserR0ControlProvideMatcher> {
  private UserR0ControlProvideQuerySpecification() {
   ...
   * 
   */
  public static UserR0ControlProvideQuerySpecification instance() throws IncQueryException {
    try{
  ...
  @Override
  protected UserR0ControlProvideMatcher instantiate(final IncQueryEngine engine) throws IncQueryException {
    return UserR0ControlProvideMatcher.on(engine);
  }
  
  @Override
  public UserR0ControlProvideMatch newEmptyMatch() {
    return UserR0ControlProvideMatch.newEmptyMatch();
  }
  
  @Override
  public UserR0ControlProvideMatch newMatch(final Object... parameters) {
    return UserR0ControlProvideMatch.newMatch((java.lang.String) parameters[0], (wt.Control) parameters[1], (wt.Signal) parameters[2], (wt.Composite) parameters[3]);
  }
  
  private static class LazyHolder {
    private final static UserR0ControlProvideQuerySpecification INSTANCE = make();
    
    public static UserR0ControlProvideQuerySpecification make() {
      return new UserR0ControlProvideQuerySpecification();					
    }
  }
  
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static UserR0ControlProvideQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    @Override
    public String getFullyQualifiedName() {
      return "org.mondo.collaboration.queries.userR0ControlProvide";
    }
    ...
    public Set<PBody> doGetContainedBodies() throws QueryInitializationException {
      ...
      try {
      {
      	...
      	new TypeConstraint(body, new FlatTuple(var_object), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://wt/access-control", "Control")));
      	new TypeConstraint(body, new FlatTuple(var_object, var__virtual_3_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://wt/access-control", "Module", "provides")));
