...
/**
 * A pattern-specific query specification that can instantiate UserR1ControlProvideMatcher in a type-safe way.
 * 
 * @see UserR1ControlProvideMatcher
 * @see UserR1ControlProvideMatch
 * 
 */
@SuppressWarnings("all")
public final class UserR1ControlProvideQuerySpecification extends BaseGeneratedEMFQuerySpecification<UserR1ControlProvideMatcher> {
  private UserR1ControlProvideQuerySpecification() {
   ...
   * 
   */
  public static UserR1ControlProvideQuerySpecification instance() throws IncQueryException {
    try{
  ...
  @Override
  protected UserR1ControlProvideMatcher instantiate(final IncQueryEngine engine) throws IncQueryException {
    return UserR1ControlProvideMatcher.on(engine);
  }
  
  @Override
  public UserR1ControlProvideMatch newEmptyMatch() {
    return UserR1ControlProvideMatch.newEmptyMatch();
  }
  
  @Override
  public UserR1ControlProvideMatch newMatch(final Object... parameters) {
    return UserR1ControlProvideMatch.newMatch((java.lang.String) parameters[0], (wt.Control) parameters[1], (wt.Signal) parameters[2], (wt.Composite) parameters[3]);
  }
  
  private static class LazyHolder {
    private final static UserR1ControlProvideQuerySpecification INSTANCE = make();
    
    public static UserR1ControlProvideQuerySpecification make() {
      return new UserR1ControlProvideQuerySpecification();					
    }
  }
  
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static UserR1ControlProvideQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    @Override
    public String getFullyQualifiedName() {
      return "org.mondo.collaboration.queries.userR1ControlProvide";
    }
