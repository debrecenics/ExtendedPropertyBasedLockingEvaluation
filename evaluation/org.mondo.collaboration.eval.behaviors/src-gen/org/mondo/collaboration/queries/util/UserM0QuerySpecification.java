...
/**
 * A pattern-specific query specification that can instantiate UserM0Matcher in a type-safe way.
 * 
 * @see UserM0Matcher
 * @see UserM0Match
 * 
...
public final class UserM0QuerySpecification extends BaseGeneratedEMFQuerySpecification<UserM0Matcher> {
  private UserM0QuerySpecification() {
   ...
   * 
   */
  public static UserM0QuerySpecification instance() throws IncQueryException {
    try{
  ...
  @Override
  protected UserM0Matcher instantiate(final IncQueryEngine engine) throws IncQueryException {
    return UserM0Matcher.on(engine);
  }
  
  @Override
  public UserM0Match newEmptyMatch() {
    return UserM0Match.newEmptyMatch();
  }
  
  @Override
  public UserM0Match newMatch(final Object... parameters) {
    return UserM0Match.newMatch((wt.Control) parameters[0], (wt.Signal) parameters[1], (java.lang.Integer) parameters[2]);
  }
  
  private static class LazyHolder {
    private final static UserM0QuerySpecification INSTANCE = make();
    
    public static UserM0QuerySpecification make() {
      return new UserM0QuerySpecification();					
    }
  }
  
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static UserM0QuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    @Override
    public String getFullyQualifiedName() {
      return "org.mondo.collaboration.queries.userM0";
    }
