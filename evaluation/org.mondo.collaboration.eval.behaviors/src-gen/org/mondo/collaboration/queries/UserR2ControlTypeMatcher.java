...
import org.mondo.collaboration.queries.UserR2ControlTypeMatch;
import org.mondo.collaboration.queries.util.UserR2ControlTypeQuerySpecification;
import wt.Composite;
import wt.Control;

/**
 * Generated pattern matcher API of the org.mondo.collaboration.queries.userR2ControlType pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link UserR2ControlTypeMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * </pre></code>
 * 
 * @see UserR2ControlTypeMatch
 * @see UserR2ControlTypeProcessor
 * @see UserR2ControlTypeQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class UserR2ControlTypeMatcher extends BaseMatcher<UserR2ControlTypeMatch> {
  /**
   ...
   * 
   */
  public static UserR2ControlTypeMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    UserR2ControlTypeMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new UserR2ControlTypeMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(UserR2ControlTypeMatcher.class);
   ...
   */
  @Deprecated
  public UserR2ControlTypeMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public UserR2ControlTypeMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a UserR2ControlTypeMatch object.
   * 
   */
  public Collection<UserR2ControlTypeMatch> getAllMatches(final String pVendor, final Control pObject, final String pType, final Composite pComposite) {
   ...
   * @param pType the fixed value of pattern parameter type, or null if not bound.
   * @param pComposite the fixed value of pattern parameter composite, or null if not bound.
   * @return a match represented as a UserR2ControlTypeMatch object, or null if no match is found.
   * 
   */
  public UserR2ControlTypeMatch getOneArbitraryMatch(final String pVendor, final Control pObject, final String pType, final Composite pComposite) {
   ...
   * 
   */
  public void forEachMatch(final String pVendor, final Control pObject, final String pType, final Composite pComposite, final IMatchProcessor<? super UserR2ControlTypeMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pVendor, final Control pObject, final String pType, final Composite pComposite, final IMatchProcessor<? super UserR2ControlTypeMatch> processor) {
   ...
   * 
   */
  public UserR2ControlTypeMatch newMatch(final String pVendor, final Control pObject, final String pType, final Composite pComposite) {
    return UserR2ControlTypeMatch.newMatch(pVendor, pObject, pType, pComposite);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfvendor(final UserR2ControlTypeMatch partialMatch) {
   ...
   * 
   */
  public Set<Control> getAllValuesOfobject(final UserR2ControlTypeMatch partialMatch) {
   ...
   * 
   */
  public Set<String> getAllValuesOftype(final UserR2ControlTypeMatch partialMatch) {
   ...
   * 
   */
  public Set<Composite> getAllValuesOfcomposite(final UserR2ControlTypeMatch partialMatch) {
  ...
  @Override
  protected UserR2ControlTypeMatch tupleToMatch(final Tuple t) {
    try {
    	return UserR2ControlTypeMatch.newMatch((java.lang.String) t.get(POSITION_VENDOR), (wt.Control) t.get(POSITION_OBJECT), (java.lang.String) t.get(POSITION_TYPE), (wt.Composite) t.get(POSITION_COMPOSITE));
  ...
  @Override
  protected UserR2ControlTypeMatch arrayToMatch(final Object[] match) {
    try {
    	return UserR2ControlTypeMatch.newMatch((java.lang.String) match[POSITION_VENDOR], (wt.Control) match[POSITION_OBJECT], (java.lang.String) match[POSITION_TYPE], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected UserR2ControlTypeMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return UserR2ControlTypeMatch.newMutableMatch((java.lang.String) match[POSITION_VENDOR], (wt.Control) match[POSITION_OBJECT], (java.lang.String) match[POSITION_TYPE], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<UserR2ControlTypeMatcher> querySpecification() throws IncQueryException {
