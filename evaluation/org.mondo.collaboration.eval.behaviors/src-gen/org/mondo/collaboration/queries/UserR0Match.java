...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.queries.userR0 pattern,
 * to be used in conjunction with {@link UserR0Matcher}.
 * 
...
public abstract class UserR0Match extends BasePatternMatch {
  ...
  private UserR0Match(final String pVendor, final Object pObject, final Composite pComposite) {
  ...
  public List<String> parameterNames() {
    return UserR0Match.parameterNames;
  }
  ...
  @Override
  public UserR0Match toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof UserR0Match)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    UserR0Match other = (UserR0Match) obj;
  ...
  @Override
  public UserR0QuerySpecification specification() {
    try {
   ...
   * 
   */
  public static UserR0Match newEmptyMatch() {
   ...
   * 
   */
  public static UserR0Match newMutableMatch(final String pVendor, final Object pObject, final Composite pComposite) {
   ...
   * 
   */
  public static UserR0Match newMatch(final String pVendor, final Object pObject, final Composite pComposite) {
    return new Immutable(pVendor, pObject, pComposite);
  }
  
  private static final class Mutable extends UserR0Match {
  ...
  private static final class Immutable extends UserR0Match {
