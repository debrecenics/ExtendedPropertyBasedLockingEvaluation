...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.queries.userR2SignalFrequency pattern,
 * to be used in conjunction with {@link UserR2SignalFrequencyMatcher}.
 * 
 ...
 * 
 * @see UserR2SignalFrequencyMatcher
 * @see UserR2SignalFrequencyProcessor
 * 
 */
@SuppressWarnings("all")
public abstract class UserR2SignalFrequencyMatch extends BasePatternMatch {
  ...
  private UserR2SignalFrequencyMatch(final String pVendor, final Signal pObject, final Integer pFrequency, final Composite pComposite) {
  ...
  public String patternName() {
    return "org.mondo.collaboration.queries.userR2SignalFrequency";
  }
  
  @Override
  public List<String> parameterNames() {
    return UserR2SignalFrequencyMatch.parameterNames;
  }
  ...
  @Override
  public UserR2SignalFrequencyMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof UserR2SignalFrequencyMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    UserR2SignalFrequencyMatch other = (UserR2SignalFrequencyMatch) obj;
  ...
  @Override
  public UserR2SignalFrequencyQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static UserR2SignalFrequencyMatch newEmptyMatch() {
   ...
   * 
   */
  public static UserR2SignalFrequencyMatch newMutableMatch(final String pVendor, final Signal pObject, final Integer pFrequency, final Composite pComposite) {
   ...
   * 
   */
  public static UserR2SignalFrequencyMatch newMatch(final String pVendor, final Signal pObject, final Integer pFrequency, final Composite pComposite) {
    return new Immutable(pVendor, pObject, pFrequency, pComposite);
  }
  
  private static final class Mutable extends UserR2SignalFrequencyMatch {
  ...
  private static final class Immutable extends UserR2SignalFrequencyMatch {
