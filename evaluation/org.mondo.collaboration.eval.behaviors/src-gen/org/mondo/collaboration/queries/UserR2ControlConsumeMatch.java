...
/**
 * Pattern-specific match representation of the org.mondo.collaboration.queries.userR2ControlConsume pattern,
 * to be used in conjunction with {@link UserR2ControlConsumeMatcher}.
 * 
 ...
 * 
 * @see UserR2ControlConsumeMatcher
 * @see UserR2ControlConsumeProcessor
 * 
 */
@SuppressWarnings("all")
public abstract class UserR2ControlConsumeMatch extends BasePatternMatch {
  ...
  private UserR2ControlConsumeMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
  ...
  public String patternName() {
    return "org.mondo.collaboration.queries.userR2ControlConsume";
  }
  
  @Override
  public List<String> parameterNames() {
    return UserR2ControlConsumeMatch.parameterNames;
  }
  ...
  @Override
  public UserR2ControlConsumeMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof UserR2ControlConsumeMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    UserR2ControlConsumeMatch other = (UserR2ControlConsumeMatch) obj;
  ...
  @Override
  public UserR2ControlConsumeQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static UserR2ControlConsumeMatch newEmptyMatch() {
   ...
   * 
   */
  public static UserR2ControlConsumeMatch newMutableMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
   ...
   * 
   */
  public static UserR2ControlConsumeMatch newMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
    return new Immutable(pVendor, pObject, pSignal, pComposite);
  }
  
  private static final class Mutable extends UserR2ControlConsumeMatch {
  ...
  private static final class Immutable extends UserR2ControlConsumeMatch {
