...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.queries.userR2ControlProvide pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link UserR2ControlProvideMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * </pre></code>
 * 
 * @see UserR2ControlProvideMatch
 * @see UserR2ControlProvideProcessor
 * @see UserR2ControlProvideQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class UserR2ControlProvideMatcher extends BaseMatcher<UserR2ControlProvideMatch> {
  /**
   ...
   * 
   */
  public static UserR2ControlProvideMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    UserR2ControlProvideMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new UserR2ControlProvideMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(UserR2ControlProvideMatcher.class);
   ...
   */
  @Deprecated
  public UserR2ControlProvideMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public UserR2ControlProvideMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a UserR2ControlProvideMatch object.
   * 
   */
  public Collection<UserR2ControlProvideMatch> getAllMatches(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
   ...
   * @param pSignal the fixed value of pattern parameter signal, or null if not bound.
   * @param pComposite the fixed value of pattern parameter composite, or null if not bound.
   * @return a match represented as a UserR2ControlProvideMatch object, or null if no match is found.
   * 
   */
  public UserR2ControlProvideMatch getOneArbitraryMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
   ...
   * 
   */
  public void forEachMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite, final IMatchProcessor<? super UserR2ControlProvideMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite, final IMatchProcessor<? super UserR2ControlProvideMatch> processor) {
   ...
   * 
   */
  public UserR2ControlProvideMatch newMatch(final String pVendor, final Control pObject, final Signal pSignal, final Composite pComposite) {
    return UserR2ControlProvideMatch.newMatch(pVendor, pObject, pSignal, pComposite);
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfvendor(final UserR2ControlProvideMatch partialMatch) {
   ...
   * 
   */
  public Set<Control> getAllValuesOfobject(final UserR2ControlProvideMatch partialMatch) {
   ...
   * 
   */
  public Set<Signal> getAllValuesOfsignal(final UserR2ControlProvideMatch partialMatch) {
   ...
   * 
   */
  public Set<Composite> getAllValuesOfcomposite(final UserR2ControlProvideMatch partialMatch) {
  ...
  @Override
  protected UserR2ControlProvideMatch tupleToMatch(final Tuple t) {
    try {
    	return UserR2ControlProvideMatch.newMatch((java.lang.String) t.get(POSITION_VENDOR), (wt.Control) t.get(POSITION_OBJECT), (wt.Signal) t.get(POSITION_SIGNAL), (wt.Composite) t.get(POSITION_COMPOSITE));
  ...
  @Override
  protected UserR2ControlProvideMatch arrayToMatch(final Object[] match) {
    try {
    	return UserR2ControlProvideMatch.newMatch((java.lang.String) match[POSITION_VENDOR], (wt.Control) match[POSITION_OBJECT], (wt.Signal) match[POSITION_SIGNAL], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected UserR2ControlProvideMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return UserR2ControlProvideMatch.newMutableMatch((java.lang.String) match[POSITION_VENDOR], (wt.Control) match[POSITION_OBJECT], (wt.Signal) match[POSITION_SIGNAL], (wt.Composite) match[POSITION_COMPOSITE]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<UserR2ControlProvideMatcher> querySpecification() throws IncQueryException {
